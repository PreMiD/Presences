...
presence.on("UpdateData", async () => {
    const page = document.location.pathname,
        game = document.querySelector("#main-wrap > main > aside > div > section > div.game__meta__infos > div > div > div") as HTMLElement,
        status = document.querySelector("#main-wrap > main > aside > div > section.status") as HTMLElement;
