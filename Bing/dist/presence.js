...
presence.on("UpdateData", () => {
    ...
    if (document.URL === "https://www.bing.com/" || document.URL === "https://www.bing.com" || document.location.href.includes("/?cc=") || document.location.href.includes("/?FORM=Z9FD1")) {
        ...
        if (document.location.href.includes("FORM=HDRSC2") || document.location.href.includes("&form=QBIR")) {
            presenceData.details = "Exploring images in search for...";
        } else if (document.location.href.includes("FORM=HDRSC3") || document.location.href.includes("&form=QBVR")) {
            presenceData.details = "Probing videos for...";
        } else if (document.location.href.includes("FORM=HDRSC4") || document.location.href.includes("&form=QBNT")) {
