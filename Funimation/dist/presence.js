...
presence.on("UpdateData", () => __awaiter(this, void 0, void 0, function* () {
    ...
    if (document.querySelector("#video-details > div > div:nth-child(2) > div > div:nth-child(1) > h1") !== null) {
        if (iFrameVideo == true && !isNaN(duration)) {
            ...
            presenceData.state = document.querySelector("#video-details > div > div:nth-child(2) > div > div:nth-child(1) > h1").textContent + " " + document.querySelector("#video-details > div > div:nth-child(2) > div > div:nth-child(1) > h2").textContent;
        ...
        if (document.location.pathname.includes("/topic/")) {
            ...
            presenceData.state = document.querySelector("head > title").textContent.replace(" | Funimation Forum", "");
            presenceData.startTimestamp = browsingStamp;
        }
        else {
