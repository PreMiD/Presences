...
function updateDropdownPresenceData(dropdown, presenceData) {
    const selectedValueStr = dropdown.value;
    const selectedOption = document.querySelector(`#searchDropdownBox > option[value="${selectedValueStr}"]`);
...
presence.on("UpdateData", () => __awaiter(this, void 0, void 0, function* () {
    ...
    const productTitleSpan = document.querySelector("span#productTitle");
    const primeVideoTitle = document.querySelector("#a-page > div.av-page-desktop.avu-retail-page > div.avu-content.avu-section > div > div > div.DVWebNode-detail-atf-wrapper.DVWebNode > div.av-detail-section > div > h1");
    const searchTermSpan = document.querySelector("#search > span > h1 > div > div.sg-col-14-of-20.sg-col-26-of-32.sg-col-18-of-24.sg-col.sg-col-22-of-28.s-breadcrumb.sg-col-10-of-16.sg-col-30-of-36.sg-col-6-of-12 > div > div > span.a-color-state.a-text-bold");
    const gcAsinTitle = document.querySelector("#gc-asin-title");
    if (productTitleSpan !== null) {
        ...
        const nameSpan = document.querySelector("#customer-profile-name-header > div.a-row.a-spacing-none.name-container > span");
        ...
        dropdown.onchange = () => updateDropdownPresenceData(dropdown, presenceData);
    }
