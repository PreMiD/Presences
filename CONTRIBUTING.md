...
13. Tags must not include any spaces, slashes, single/double quotation marks, or any other special characters (Characters from other languages are permitted). Uppercase and lowercase characters as well as numbers are permitted. 
