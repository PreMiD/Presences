...
uvu.on("UpdateData", () => {
    ...
    if (path === "/") {
        if (document.querySelector(".tab-item.active").id == "homeLink") {
            ...
            if (document.querySelector(".tab-item.active").id == "guideLink") {
                presenceData.details = "Viendo la lista de guías";
                presenceData.startTimestamp = browsingStamp;
            } else
                if (document.querySelector(".tab-item.active").id == "toolsLink") {
                    presenceData.details = "Viendo la lista de herramientas"
                    presenceData.startTimestamp = browsingStamp;
                } else
                    if (document.querySelector(".tab-item.active").id == "otherLink") {
                        presenceData.details = `Viendo la lista de otros`
                        presenceData.startTimestamp = browsingStamp;
                    }
    }
    else
        if (owo[1] === "leaderboard") {
            ...
            if (owo[1] === "logros") {
                ...
                if (owo[1] === "logro") {
                    presenceData.details = `Viendo un logro (#${document.querySelector("kbd").innerHTML.slice(10)})`;
                        ...
                        if (owo[1] === "guia") {
                            ...
                            if (owo[1] === "u") {
                                ...
                                if (owo[1] === "mybotlist") {
                                    ...
                                    if (owo[1] === "app" && owo[2] === "verificador" && owo[3] === "perfil") {
