...
presence.on("UpdateData", async () => {
  ...
  if (itemsetting == true && itemsite == true) { // Ask for Settings
    itemdesc = document.querySelector("#related-products-scroll-container > div > div > div.ProductContainer__ProductMainSection-sc-1vbd28u-1.eUuuzm > div.ProductContainer__RightColumn-sc-1vbd28u-3.hivhfu > div > div.PurchaseContainer__UpperWrapper-sc-1qlezk8-1.jEnuPa > h1").innerText;
