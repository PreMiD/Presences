...
presence.on("UpdateData", () => {
  ...
  if (document.location.pathname == "/") {
    ...
    nameofserie = document.querySelector(
    ...
    try {
      ...
      titleofserie = document.querySelector(
    ...
    katalog1 = document.querySelector(
    ...
    supportzahl = document.querySelector(
