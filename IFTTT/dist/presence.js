				...
				switch (path[0]) {
					...
					case "connect":
						...
						presenceData.state = `Connect ${
							document.querySelector("h1").firstElementChild.title
						} to ${document.querySelector("h1").lastElementChild.title}`;
						break;
					//Explore
					//------------------------------------------------------------------------------
					case "discover":
					...
					case "search":
						...
						presenceData.state = `Tab: ${
							document.getElementsByClassName("active")[1].innerText
						}`;
						break;
					//Trust & Privacy
					//------------------------------------------------------------------------------
