...
presence.on("UpdateData", () => __awaiter(this, void 0, void 0, function* () {
    const page = document.location.pathname,
        subdomain = document.location.hostname.split(".") ? document.location.hostname.split(".")[0] : document.location.hostname,
        title = document.querySelector("#\\35 ee1 > h1") || document.querySelector("#\\33 d2a > h1") || document.querySelector("h1"),
        author = document.querySelector("#root > div > article > div > section > div > div.kl > div > div.ks.af.l > div > div > span > div > span > a") || document.querySelector("#root > div > article > div > section > div > div.fr > div > div.fz.af.l > div > div > span > div > span > a") || document.querySelector("div > span > a"),
        createdAt = document.querySelector("#root > div > article > div > section > div > div.kl > div > div.ks.af.l > span > span > div > a") || document.querySelector("#root > div > article > div > section > div > div.fr > div > div.fz.af.l > span > span > div > a") || document.querySelector("span > span > div > a"),
        draft = document.querySelector("#_obv\\.shell\\._surface_1570974921796 > div > div.metabar.u-clearfix.u-fixed.u-backgroundTransparentWhiteDarkest.u-xs-sizeFullViewportWidth.js-metabar > div.js-metabarMiddle.metabar-inner.u-marginAuto.u-maxWidth1032.u-flexCenter.u-justifyContentSpaceBetween.u-height65.u-xs-height56.u-paddingHorizontal20 > div.metabar-block.u-flex1.u-flexCenter > div.u-flexCenter.u-height65.u-xs-height56.u-marginLeft10 > span"),
        href = document.location.href.replace("https://", "").replace("http://", "");
    ...
    if (page == "/new-story" || page == "/new-story/" || draft && draft.textContent != "") {
        const newArticleTitle = document.querySelector("#editor_6 > section > div.section-content > div > h3");

        data.details = "Writing a New Story";
        data.state = newArticleTitle && newArticleTitle.textContent != "" ? newArticleTitle.textContent : "No title set.";
    ...
    } else if (href.includes("medium.com/@") && href.match("[^/]*$")[0].includes("@") && href.match("[^/]*$")[0] == href.slice(-href.match("[^/]*$")[0].length) && title && title.textContent != "") {
        data.details = "Viewing a profile:";
        data.state = title.textContent;
    } else if (title && title.textContent != "" && author && author.textContent != "" || author && author.textContent && document.title.includes(author.textContent + " - ")) {
        data.details = title ? title.textContent : document.title.replace(author.textContent + " - ", "");
        data.state = `by ${author.textContent}${createdAt && createdAt.textContent != "" ? " • " + createdAt.textContent : ""}`;
        ...
        data.state = searchingFor && searchingFor.textContent != "" ? searchingFor.textContent : "Something...";
