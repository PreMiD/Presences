...
presence.on("UpdateData", async () => {
    const category = document.querySelector("#widget_serie_contents_3 > section > div > div > div.category-main-content-right > header > h1 > strong") as HTMLElement;
    ...
    if (document.location.pathname == "/" || !document.location.pathname || category && category.innerHTML != "") {
        ...
        const video = document.querySelector("#dyg_player_dogusPlayer_html5_api") as HTMLVideoElement;
        ...
        if (!video) return;
            ...
            let data: { [k: string]: any } = {
                ...
                state: episode != "" ? episode : `${document.querySelector("#widget_serie_detail_tab_5 > section > div > div > div > div.kunye-content-left > div:nth-child(3)") ? (document.querySelector("#widget_serie_detail_tab_5 > section > div > div > div > div.kunye-content-left > div:nth-child(3)") as any).innerText.replace("\n", ": ") : null}`,
