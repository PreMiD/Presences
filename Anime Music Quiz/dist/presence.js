        ...
        if (document.location.pathname == ("/")) {
            if (document.querySelector("#gameChatPage") != null) {
                if (document.querySelector("#roomBrowserPage").className != "gamePage text-center hidden") {
                    ...
                    var lobbyNumber = document.querySelector("#rbTotalGameCount").innerText;
                    ...
                    if (document.querySelector("#lobbyPage").className == "text-center") {
                        browsingStamp = Math.floor(Date.now() / 1000);
                        var lobbyName = document.querySelector("#lobbyRoomName").textContent;
                        ...
                        if (document.querySelector("#battleRoyalPage").className == "text-center") {
                            var timeRemainingBR = document.querySelector("#brTimeLeft").innerText;
                            ...
                            var totalRoundNumber = document.querySelector("#qpCounter").innerText.replace("/", " of ");
                            var actualRoundNumber = document.querySelector("#qpCounter").innerText.split("/")[0];
                            if (document.querySelector("#qpAnimeNameHider").className == "center-text qpAnimeNameContainer hide") {
                                var animeName = document.querySelector("#qpAnimeName").textContent;
                                ...
                                if (document.querySelector("#qpHiderText").textContent.startsWith("Loading")) {
                                    ...
                                    var timeRemaining = document.querySelector("#qpHiderText").textContent;
                                    data.smallImageKey = "gamepad",
                ...
                if (document.querySelector("#roomBrowserPage").className != "gamePage text-center hidden") {
                    ...
                    if (document.querySelector("#lobbyPage").className == "text-center") {
                        ...
                        if (document.querySelector("#battleRoyalPage").className == "text-center") {
                            ...
                            var totalRoundNumber = document.querySelector("#qpCounter").innerText.replace("/", " di ");
                            var actualRoundNumber = document.querySelector("#qpCounter").innerText.split("/")[0];
                            if (document.querySelector("#qpAnimeNameHider").className == "center-text qpAnimeNameContainer hide") {
                                var animeName = document.querySelector("#qpAnimeName").textContent;
                                data.smallImageKey = "headset",
