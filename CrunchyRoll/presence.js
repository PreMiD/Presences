...
presence.on("UpdateData", function () { return __awaiter(_this, void 0, void 0, function () {
    var video, video, videoTitle, uploader, timestamps, presenceData, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                video = document.querySelector("div #player video#player_html5_api");
                playback =
                    video !== null
                        ? true : false;
                if (!playback) {
                ...
                video = document.querySelector(".video-js#player video");
                if (!(video !== null && !isNaN(video.duration))) return [3 /*break*/, 5];
                videoTitle = document.querySelector('#bread .breadcrumb .active');
                uploader = '', timestamps = getTimestamps(Math.floor(video.currentTime), Math.floor(video.duration));
                _a = {
                    largeImageKey: "lg",
            ...
            case 3:
                ...
                _c.label = 4;
            case 4:
                presenceData = (_a.smallImageText = _b,
