...
presence.on("UpdateData", () => {
    ...
    if (document.getElementsByClassName("sics-component__headline__title")[0] === undefined) {
        if (document.URL === "https://www.stuff.co.nz/" || document.URL === "https://www.stuff.co.nz") {
            ...
            if (document.location.href.includes("/nz-earthquake")) {
                ...
                presenceData.state = document.getElementsByClassName("section-location-header")[0].innerText || "National Forecast";
        ...
        presenceData.state = document.getElementsByClassName("sics-component__headline__title")[0].innerText;
        presenceData.startTimestamp = Math.floor(Date.now() / 1000);
    }
