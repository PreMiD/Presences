			...
			default:
				if (path[0]) {
					if (document.getElementById("station-website")) {
						...
						//---------------------------------------
						if (
							document.getElementsByClassName("song-name")[0].innerText.length >
							0
						) {
							if (
								...
								if (
									!browsingStamp ||
									lastRadio !=
										document.getElementsByClassName("song-name")[0].innerText
								)
					...
					//---------------------------------------
					if (
						document.getElementsByClassName("song-name")[0].innerText.length > 0
					) {
						if (
							document.getElementsByClassName(
								"playbutton-global playbutton-global-playing"
	...
	switch (key) {
		...
		case "pause":
			if (
				...
				document.getElementsByClassName(
					"playbutton-global playbutton-global-paused"
				).length > 0
			) {
				document
					.getElementsByClassName(
