const presence = new Presence({
  ...
  nextEpisodeElement = document.querySelector("div#sidebar-anime-info > div.border.rounded.mb-3.p-3:nth-child(2) > div:nth-child(1) > a.ka-url-wrapper"),
  previousEpisodeElement = document.querySelector("div#sidebar-anime-info > div.border.rounded.mb-3.p-3:nth-child(2) > div:nth-child(2) > a.ka-url-wrapper");
...
presence.on("UpdateData", async () => {
  ...
  if (document.location.pathname.includes("/anime/") && document.location.pathname.includes("/episode")) {
    checkIfMovie();
    if (playback == true && !isNaN(duration)) {
      ...
      currentAnimeWatching = document.querySelector("h1.title").textContent.split('-'),
      currentAnimeEpisode = isMovie == true 
        ? "Movie" 
        : currentAnimeWatching[1].substring(1, currentAnimeWatching[1].length);
      ...
      if (paused) {
        ...
        currentAnimeWatching = document.querySelector("h1.title").textContent.split('-'),
          currentAnimeTitle = currentAnimeWatching[0].substring(0, currentAnimeWatching[0].length - 1),
          currentAnimeEpisode = isMovie == true 
            ? "Movie" 
            : currentAnimeWatching[1].substring(1, currentAnimeWatching[1].length);
  ...
  else if (document.location.pathname.includes("/anime/") && document.location.pathname.includes("/episode") == false) {
