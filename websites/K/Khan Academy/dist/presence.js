    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!document.location.pathname.includes("/profile")) return [3 /*break*/, 2];
                _a = data;
                return [4 /*yield*/, strings];
            case 1:
                _a.details = (_c.sent()).homepage;
                return [3 /*break*/, 5];
            case 2:
                if (!document.location.pathname.includes("/settings")) return [3 /*break*/, 4];
                _b = data;
                return [4 /*yield*/, strings];
            case 3:
                _b.details = (_c.sent()).settings;
                return [3 /*break*/, 5];
            case 4:
