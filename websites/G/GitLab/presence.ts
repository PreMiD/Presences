...
presence.on("UpdateData", async () => {
  ...
  if (window.location.hostname == "gitlab.com") {
    if (
      ...
      if (document.location.pathname == "/dashboard/projects/starred")presenceData.details = "Viewing Starred";
      else presenceData.details = "Viewing Dashboard";
    } else if (document.location.pathname == "/projects/new/")presenceData.details = "Creating a project";
     else if (document.location.pathname == "/groups/new")presenceData.details = "Creating a group";
    ...
    else if (document.location.pathname == "/dashboard/milestones") presenceData.details = "Viewing Milestones";

    else if (document.location.pathname == "/dashboard/snippets") presenceData.details = "Viewing Snippets";

    else if (document.location.pathname == "/-/operations/environments") presenceData.details = "Viewing Environments";

    else if (document.location.pathname == "/-/operations") presenceData.details = "Viewing Operations";

    else if (document.location.pathname == "/-/security") presenceData.details = "Viewing Security";

    else if (document.location.pathname == "/dashboard/issues") presenceData.details = "Viewing Issuses";

    else if (document.location.pathname == "/dashboard/merge_requests") presenceData.details = "Viewing Merge Requests";

    else if (document.location.pathname == "/dashboard/todos") presenceData.details = "Viewing TODOS";

    else if (document.location.pathname == "/help") presenceData.details = "Viewing Help";

    else if (document.location.pathname == "/users/sign_in") presenceData.details = "Signning in or Registering";

    else if (document.location.pathname == "/users/sign_in") presenceData.details = "Signning in";
