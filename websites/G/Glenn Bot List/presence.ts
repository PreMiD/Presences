...
const title =
  document
    ...
    .textContent.replace("| Glenn Bot List", " ")
    .replace("- Glenn Bot List API", " ") ?? "Glenn Bot List!";
    ...
    if (path.hostname.includes("docs.")) {
      ...
      if (path.pathname.includes("stats")) {
        const user =
          document.querySelector(
            "body > main > div.justify-content-center.mt-5 > div > h4"
          ).textContent ?? "UnknowUser#0000";
        const karma =
          document
            .querySelector(
              "body > main > div.justify-content-center.mt-5 > div > ul > li:nth-child(3) > span"
            )
            .textContent.replace("Total Karma", " Total Karma") ??
          "0 Total Karma";
        presenceData.startTimestamp = browsingStamp;
      ...
      if (path.pathname.includes("edit")) {
        ...
        const vote = document.querySelector(
          "body > main > div > div:nth-child(1) > div.col-md-3.text-center.bot-page-card.bot-page-card-small.shadow-2 > div:nth-child(7) > span:nth-child(2)"
        );
        const decs = document.querySelector(
          "body > main > div > div:nth-child(1) > div.col-md-6.text-center.bot-page-card.bot-page-card-large.shadow-2 > div > div:nth-child(1) > div > div:nth-child(1) > p"
        );
        presenceData.startTimestamp = browsingStamp;
        presenceData.details = title;
