...
presence.on("UpdateData", async () => {
  ...
  const articleTitles = document.querySelector("#__next > div.p16bck5y > header > div > header > h1");
  const newsPublisher = document.querySelector("#__next > div.p16bck5y > header > div > div.b12pz0kr > a");
  const authorName = document.querySelector("#__next > div.p16bck5y > header > div > div.b12pz0kr > ul > li");
  //This is just here so that I can have "changes"  to push to GitHub
  //This is just to push to GitHub

console.log(exploreTitles?.innerText)
