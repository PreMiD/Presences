...
presence.on("UpdateData", async () => {
  ...
  data.presence = {
    ...
    "/community/forums/": {
      setPresenceData(){
        presenceData.details = "Browsing forums:";
        presenceData.state = document.querySelector("span.ng-star-inserted").textContent;
      }
    },
    "/community/forums/([a-z]+)/([a-z0-9]+)": {
      setPresenceData(){
        presenceData.details = "Viewing forum:";
        presenceData.state = document.querySelector("body > app-root > div > x-discussion-view > div > h2").textContent.trim();
    ...
    "/club/([a-z0-9-])": {
      setPresenceData(){
        ...
        presenceData.state = document.querySelector("span.ng-tns-c123-778").textContent;
    ...
    "/user/([a-zA-Z0-9-]+)": {
      setPresenceData(){
        ...
        presenceData.state = document.querySelector("x-user-name > div")?.textContent;
    ...
    "/shop/([a-z-]+)":  {
      setPresenceData(){
        ...
        presenceData.state = `Shop • ${
          document.querySelector("div.box-title-tab.bt.br.bl.nowrap.b5.bg5.color5.ng-star-inserted").textContent.trim()}`;
    ...
    "/games/": {
      setPresenceData(){
        ...
        presenceData.state = document.querySelector("div.box-title").textContent;
