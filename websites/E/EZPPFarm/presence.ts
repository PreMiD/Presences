...
presence.on("UpdateData", () => {
  ...
  if (document.location.pathname === "/") presenceData.details = "Viewing the home page";
    ...
    switch (mode) {
      case 1:
        rank = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div.ui.top.attached.segment.overflow.auto > div > div:nth-child(5) > h1:nth-child(3)");
        pp = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div:nth-child(2) > div > div > div > div:nth-child(2) > table > tbody > tr:nth-child(2) > td.right.aligned");
        ...
        break;
      case 2:
        rank = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div.ui.top.attached.segment.overflow.auto > div > div:nth-child(5) > h1:nth-child(4)");
        pp = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div:nth-child(2) > div > div > div > div:nth-child(3) > table > tbody > tr:nth-child(2) > td.right.aligned")
        presenceData.state = `Rank ${rank.innerText} | ${pp.innerText}pp`
        presenceData.smallImageKey = "ctb"
        presenceData.smallImageText = "osu!catch"
        break;
      case 3:
        rank = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div.ui.top.attached.segment.overflow.auto > div > div:nth-child(5) > h1:nth-child(5)")
        pp = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div:nth-child(2) > div > div > div > div:nth-child(4) > table > tbody > tr:nth-child(2) > td.right.aligned");
        presenceData.state = `Rank ${rank.innerText} | ${pp.innerText}pp`
        presenceData.smallImageKey = "mania"
        presenceData.smallImageText = "osu!mania"
        break;
      default:
        rank = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div.ui.top.attached.segment.overflow.auto > div > div:nth-child(5) > h1:nth-child(2)")
        pp = document.querySelector("body > div > div.h-container > div:nth-child(2) > div > div.five.wide.column > div:nth-child(2) > div > div > div > div:nth-child(1) > table > tbody > tr:nth-child(2) > td.right.aligned");
        presenceData.state = `Rank ${rank.innerText} | ${pp.innerText}pp`
    ...
    title = document.querySelector("body > div.ui.full.height.main.wrapper > div.h-container > div:nth-child(2) > div.ui.top.attached.segment.overflow.auto.aligned > div > div:nth-child(2) > h1")
    tag = document.querySelector("body > div.ui.full.height.main.wrapper > div.h-container > div:nth-child(2) > div.ui.top.attached.segment.overflow.auto.aligned > div > div:nth-child(2) > div")
