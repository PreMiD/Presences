...
presence.on("UpdateData", async () => {
  ...
  if (document.location.hostname === "emoji.gg") {
    ...
    } else if (document.location.pathname.includes("/category/") || document.location.pathname.includes("/emojis/")) {
      title = document.querySelector(
        "h1"
      );
      presenceData.startTimestamp = browsingStamp;
