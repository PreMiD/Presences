...
botPresence.on("UpdateData", async () => {
  ...
  if (botHost === "discord-botlist.eu") {
    if (botPage === "/") botData.details = "Browsing";
      ...
      if (botPage.includes("/new")) botData.details = "Adding a Bot";
      ...
      } else if (botPage.includes("/edit")) botData.details = "Editing a Bot";
    ...
    else if (botPage === "/tos/") botData.details = "Viewing ToS";
