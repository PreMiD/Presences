...
presence.on("UpdateData", async () => {
	...
	default: if (document.URL.startsWith("https://diziwatch.net/dizi/")) {
		...
		const currentTime = document.querySelector("#player > div.jw-wrapper.jw-reset > div.jw-controls.jw-reset > div.jw-controlbar.jw-reset > div.jw-reset.jw-button-container > div.jw-icon.jw-icon-inline.jw-text.jw-reset.jw-text-elapsed").textContent,
  		 duration = document.querySelector("#player > div.jw-wrapper.jw-reset > div.jw-controls.jw-reset > div.jw-controlbar.jw-reset > div.jw-reset.jw-button-container > div.jw-icon.jw-icon-inline.jw-text.jw-reset.jw-text-duration").textContent,
		 videoTitle = document.querySelector("#player > div.jw-wrapper.jw-reset > div.jw-title.jw-reset-text > div.jw-title-primary.jw-reset-text").textContent,
		 
		 animeImg = document.querySelector("#player > div.jw-wrapper.jw-reset > div.jw-preview.jw-reset").getAttribute("style").split('"')[1],

		 playStatus = document.querySelector("#player > div.jw-wrapper.jw-reset > div.jw-controls.jw-reset > div.jw-display.jw-reset > div > div > div.jw-display-icon-container.jw-display-icon-display.jw-reset > div").getAttribute("aria-label");
		...
		presenceData.largeImageText = document.querySelector("#benzerli > div > span").textContent;
