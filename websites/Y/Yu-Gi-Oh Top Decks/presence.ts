...
presence.on("UpdateData", async () => {
  if (document.location.pathname === "/") {
    ...
    const pagenumber = document.getElementsByClassName("current")[0]
        .firstElementChild.textContent,
      no1 = document.getElementById("deck_lists").lastElementChild
        .firstElementChild.children[2].textContent,
      auth = document.getElementById("deck_lists").lastElementChild
        .firstElementChild.children[1].ENTITY_NODE,
      deckurl = (document.getElementById("deck_lists").lastElementChild
        .firstElementChild.children[2].firstElementChild as HTMLLinkElement)
        .href,
    ...
    const top = document.getElementsByClassName("sortable")[0].children[1]
        .firstElementChild.children[2].textContent,
      price = document.getElementsByClassName("sortable")[0].children[1]
