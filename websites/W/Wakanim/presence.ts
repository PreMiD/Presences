...
presence.on('UpdateData', async () => {
  const presenceData: PresenceData = {
    largeImageKey: 'https://cdn.rcd.gg/PreMiD/websites/W/Wakanim/assets/0.png',
  }
  const video = document.querySelector<HTMLVideoElement>('video')
  const title = document.querySelector<HTMLSpanElement>('.episode_title')
  const subtitle = document.querySelector<HTMLSpanElement>('.episode_subtitle')
