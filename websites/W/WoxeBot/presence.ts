const presence = new Presence({
  ...
  presence.on("UpdateData", async () => {
    ...
    if (document.location.hostname == "panel.woxe.me") {
        ...
        } else if (document.location.pathname == "/manage" || document.location.pathname == "/manage/") {
          presenceData.details = "Sunucularını inceliyor...";
        } else if (document.getElementsByClassName("manage-content") && document.getElementsByClassName("input-div") && document.location.pathname.includes("/guild/")) {
