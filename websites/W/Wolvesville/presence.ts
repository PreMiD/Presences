...
presence.on("UpdateData", async () => {
  ...
  if (document.location.href.includes("blog.wolvesville.com")) { //Wolvesville Blog
    ...
    document.querySelector(
      ...
      ? data.details = "Loading Wolvesville..." : false;
      ...
      if (showMenuState) {
        ...
        if (clan) {
          document.querySelector(
            ...
            ? data.state = "Browsing clans..." : data.state = "Viewing their clan";
        }
      }
    }
    ...
    document.querySelector(
      ...
      ? data.details = "Browsing custom games..." : false;
    ...
    if (lobby) {
      document.querySelector(
        "div.css-1dbjc4n.r-1awozwy.r-173mn98.r-18u37iz"
      )
        ? data.details = "In a friends lobby" : data.details = "In a custom lobby";
    ...
    if (game) {
      ...
      if (preGameLobby && lobbyChar === "") {
        ...
        document.querySelector(
          ...
          ? data.details = "Spectating a game" : false;
