...
presence.on("UpdateData", async () => {
	let presenceData = {
		...
		largeImageKey: "https://cdn.rcd.gg/PreMiD/websites/C/Currys/assets/logo.png",
	...
	if (search?.value) {
		...
		presenceData.smallImageKey = "https://cdn.rcd.gg/PreMiD/websites/C/Currys/assets/0.png";
