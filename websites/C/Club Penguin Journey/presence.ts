	...
	switch (document.location.hostname) {
		...
		case "play.cpjourney.net": {
			if (document.location.pathname === "/") {
				...
				if (Number(status.roomId) === 1) presenceData.state = "Welcome Room";
				else if (Number(status.roomId) === 2) presenceData.state = "Tour HQ";
				else if (Number(status.roomId) === 3)
					presenceData.state = "The Outlook";
				else if (Number(status.roomId) === 4) presenceData.state = "Ice Pond";
				else if (Number(status.roomId) === 100) presenceData.state = "Town";
				...
				else if (Number(status.roomId) === 210) presenceData.state = "Ice Pond";
				...
				else if (Number(status.roomId) === 230) presenceData.state = "Ski Hill";
				else if (Number(status.roomId) === 300) presenceData.state = "Plaza";
				else if (Number(status.roomId) === 310) presenceData.state = "Pet Shop";
				else if (Number(status.roomId) === 319)
					presenceData.state = "Dojo Courtyard";
				else if (Number(status.roomId) === 320) presenceData.state = "Dojo";
				else if (Number(status.roomId) === 330)
					presenceData.state = "Pizza Parlor";
				else if (Number(status.roomId) === 340) presenceData.state = "Stage";
				else if (Number(status.roomId) === 400) presenceData.state = "Beach";
				else if (Number(status.roomId) === 410)
					presenceData.state = "Lighthouse";
				else if (Number(status.roomId) === 411) presenceData.state = "Beacon";
				else if (Number(status.roomId) === 800) presenceData.state = "Dock";
				else if (Number(status.roomId) === 801)
					presenceData.state = "Snow Forts";
				else if (Number(status.roomId) === 802) presenceData.state = "Stadium";
				else if (Number(status.roomId) === 803) presenceData.state = "HQ";
				else if (Number(status.roomId) === 804)
					presenceData.state = "Boiler Room";
				else if (Number(status.roomId) === 805) presenceData.state = "Iceberg";
				...
				else if (Number(status.roomId) === 808) presenceData.state = "Mine";
				else if (Number(status.roomId) === 809) presenceData.state = "Forest";
				else if (Number(status.roomId) === 810) presenceData.state = "Cove";
