...
presence.on("UpdateData", async () => {
    ...
    if(path == "/"){
        ...
        title = (document.querySelector("#mainTag > section > div:nth-child(1) > div.small-12.medium-9.columns > div.title-wrapper > h1") as HTMLTextAreaElement);
        ...
        if(title && chapter){
            ...
            title = (document.querySelector("#mainTag > div.row.background-white > div.small-12.medium-9.columns.left-rail-column.clear-padding-for-small-only > div > div.small-12.medium-9.columns > div > div > div > div.small-12.medium-12.columns.clear-padding > article > h2") as HTMLTextAreaElement);
            if(title){
                presenceData.details = title.innerText;
                presenceData.startTimestamp = browsingStamp;
            }
        ...
        title = (document.querySelector("#phsubheader_0_headerTitle") as HTMLTextAreaElement);
        ...
        search = (document.querySelector("#phsection1_1_phmiddlesection_0_searchResults > div > h3 > span") as HTMLTextAreaElement);
        if(search){
