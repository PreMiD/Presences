...
presence.on('UpdateData', async () => {
  ...
  const bodyWrap = document.querySelector('body > div.wrap > div')!
  ...
  if (path === '/') {
    ...
    const ordenarTexto = document.querySelector(
    ...
    const OrdenarTextoObra = document.querySelector(
      'body > div.wrap > div > div > div.c-page-content.style-1 > div > div > div > div > div.main-col-inner > div > div.c-page__content > div.tab-wrap > div > div.c-nav-tabs > ul > li.active',
    )
    const GeneroTexto = document.querySelector(
    ...
    const StatusContaTexto = document.querySelector(
    ...
    if (path.split('/').length - 1 === 3) {
      const tipoObra = document.querySelector(
      ...
      const generoObra = document.querySelector(
      ...
      const nomeObra = document.querySelector(
        'body > div.wrap > div > div > div > div.profile-manga > div > div > div > div.post-title > h1',
      )
      const spanObra = document.querySelector(
      ...
      const seasonLeitor = document.querySelector<HTMLSelectElement>(
      ...
      const paginaLeitor = document.querySelector<HTMLSelectElement>('#single-pager')
      const capituloLeitor = document.querySelector(
      ...
      const nomeObraLeitor = document.querySelector(
      ...
      const opcaoLeitor = document.querySelector(
    ...
    const postagemData = document.querySelector(
      'div.entry-header > div > div.entry-meta > div.post-on',
    )
  ...
  if (
    ...
    presenceData.largeImageKey = 'https://cdn.rcd.gg/PreMiD/websites/N/Neox%20Scanlator/assets/0.png'
  }
  else if (
    window.getComputedStyle(bodyWrap).getPropertyValue('background-color')
    !== 'rgb(38, 38, 38)'
  ) {
    presenceData.largeImageKey = 'https://cdn.rcd.gg/PreMiD/websites/N/Neox%20Scanlator/assets/logo.png'
  }
  ...
  if (UsuarioTexto && PesquisaTexto === null) {
    presenceData.smallImageKey = 'https://cdn.rcd.gg/PreMiD/websites/N/Neox%20Scanlator/assets/1.png'
