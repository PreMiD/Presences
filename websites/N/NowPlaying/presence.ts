...
presence.on("UpdateData", async () => {
  ...
  var presenceData: presenceData = {
    ...
    details: document.getElementById('name').textContent, //The upper section of the presence text
    state: document.getElementById('artists').textContent, //The lower section of the presence text
