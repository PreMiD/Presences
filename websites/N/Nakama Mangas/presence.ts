...
const projetosTipo: HTMLElement = document.querySelector(
  "ol.breadcrumb li.active"
);
const mangaTitulo: HTMLElement = document.querySelector(
  "div.col-md-8 h1.media-heading"
);
const mangaStatus: HTMLElement = document.querySelector(
  "#blog > div > div > div > div.col-md-8 > ul > li:nth-child(1) > span"
);
const mangaAno: HTMLElement = document.querySelector(
  "#blog > div > div > div > div.col-md-8 > ul > li:nth-child(2)"
);
const tituloNoticia: HTMLElement = document.querySelector(
