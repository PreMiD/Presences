...
presence.on("UpdateData", async () => {
    ...
    if (document.location.pathname === "/") {
        ...
        const titleSplit = document.title.split('Profil von '), userName = titleSplit[1];
        ...
        const titleSplit = document.title.split('›').map((s) => s.trim()), animeName = titleSplit[2], episode = titleSplit[3];
