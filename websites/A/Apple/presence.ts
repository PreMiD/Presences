  ...
  if(urlpath[1] !== 'shop' && urlpath[2] !== 'shop' && window.location.hostname === "www.apple.com") {
    ...
    if(urlpath.includes("compare") && includesProduct) {
      ...
      if(urlpath.includes('feature')) {
        presenceData.state = document.querySelector("h1.editorial-page__header-headline")?.textContent || "Unknown";
        ...
        presenceData.state = document.querySelector("h1.typography-headline-elevated")?.textContent || document.querySelector("h1.typography-headline-reduced")?.textContent || "Unknown";
    ...
    } else if(urlpath.includes('ios') || urlpath.includes('watchos') || urlpath.includes('ipados') || urlpath.includes('macos')) {
      const OS = document.querySelector("div.ac-ln-title>a") || document.querySelector("h1.typography-hero-eyebrow.hero-eyebrow.hero-copy-item");
      ...
      const event = document.querySelector("p.hero-subhead.typography-quote-reduced");
    ...
    if(sProducts.find(e => urlpath.includes(e))) {
      ...
      presenceData.state = document.querySelector("h1.pageTitle-heading")?.textContent || document.querySelector("h1#main-title")?.textContent || 'Unknown';
