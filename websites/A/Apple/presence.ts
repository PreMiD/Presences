...
interface LangStrings {
  ...
  shopGiftCards: string;
  shopPlanVisit: string;
  shopRefurbished: string;
  shopBag: string;
  shopBagSummary: string;
  support: string;
  supportArticle: string;
  appStoreCon: string;
  iCloudMail: string;
  iCloudContacts: string;
  iCloudCalendar: string;
  iCloudPhotos: string;
  iCloudNotes: string;
  iCloudReminders: string;
  iCloudPagesCreate: string;
  iCloudKeynoteWait: string;
  devNew: string;
  devSubmit: string;
  devPhonePad: string;
  ...
  statePaused: string;
  statePlaying: string;
  btnViewProduct: string;
  btnViewService: string;
  btnViewArticle: string;
  btnViewEvent: string;
  btnViewOS: string;
  btnViewStudio: string;
  btnViewApp: string;
  btnViewDeveloper: string;
  btnViewWWDC: string;
  btnViewThread: string;
  btnViewTags: string;
  btnViewProfile: string;
  btnViewPage: string;
  btnGViewProfile: string;
  btnGWatchVideo: string;
}
