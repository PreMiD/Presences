	...
	updatePresence = () => {
		...
		if (document.location.pathname === "/") {
			...
			presenceData.details =
				document.querySelectorAll(".t-title > .ng-star-inserted")[1]
					?.textContent || "Loading";
			presenceData.state =
				document.querySelector(".episode-number")?.textContent || "Loading";
			...
			presenceData.largeImageKey = animeImg;
			presenceData.details =
				document.querySelector(".t-title a")?.textContent || "Loading";
