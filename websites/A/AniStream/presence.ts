...
const page = document.location.pathname,
  ...
  presenceData.details = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div.app-detail.flex-fill > div.detail-content > div.detail-text.flex-fill > div.caption > div.caption-content > a > h1")as HTMLElement).textContent}`
presenceData.state = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div.app-detail.flex-fill > div.detail-content > div.detail-text.flex-fill > div.caption > div.caption-content > h3") as HTMLElement).textContent}` + " - " + `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div > div.detail-content > div.detail-text.flex-fill > div.caption > div.caption-content > h2").textContent)}`
  .replace(",", " | ")
...
if (!isNaN(duration)) {
  ...
  if (paused) {
    ...
    presenceData.state = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div > div > div > div.profile-header > div.profile-content > div.name")as HTMLElement).textContent}`;
    presenceData.smallImageKey = avatar
    presenceData.smallImageText = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div > div > div > div.profile-header > div.profile-content > div.name")as HTMLElement).textContent}`;
  ...
  //LINKE LEISTE & OBERE 
    ...
    presenceData.state = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div > div.d-flex > div > div > div.mb-4 > div.subtext.text-12").textContent)}`
    .replace("verbal"," - ")
    ...
    presenceData.state = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div > div.detail-content > div.detail-text.flex-fill > div.caption > div.caption-content > h1").textContent)}`
    ...
    presenceData.state = `${(document.querySelector("body > div.container > div > div.app-wrapper > div.app-container.flex-fill > div > div > div.flex-fill > div > div.text-24.text-white.font-weight-bold").textContent)}`
