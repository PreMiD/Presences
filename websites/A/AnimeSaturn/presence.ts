...
presence.on("UpdateData", async () => {
  ...
  if (document.location.pathname === "/") {
    ...
    if (endTimestamp && !paused) data.endTimestamp = endTimestamp;
    ...
    if (document.location.href.endsWith("=alt")) {
      ...
      if (fullName.includes(" Special")) {
        ...
        [videoName] = fullName.split(" OVA ");
        [videoEpisode] = fullName.split(" OVA ");
        ...
        [videoName] = fullName.split(" Episodio ");
        [videoEpisode] = fullName.split(" Episodio ");
        if (videoName.includes(" (ITA)"))
          videoName = videoName.replace(" (ITA)", "");
