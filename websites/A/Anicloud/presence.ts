...
presence.on("UpdateData", async () => {
  ...
  if (document.location.pathname.startsWith("/anime/")) {
  ...
  } else if (document.location.pathname === "/") presenceData.details = "Home";
    ...
    const [text] = document.querySelector("title").textContent.split("|");
    ...
    const [date] = document.querySelector("title").textContent.split("|");
