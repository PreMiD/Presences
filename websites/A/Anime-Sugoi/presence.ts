...
const subauthor = document.querySelector("body > div:nth-child(3) > div > div.col-lg-9 > div > div.panel-body > div:nth-child(5) > div > div:nth-child(1) > div.panel-body > p:nth-child(2)");
const subauthorplay = document.querySelector("body > div:nth-child(3) > div > div.col-lg-9 > div > div.panel-body > p:nth-child(15)");
const title1 = title?.textContent ?? "ไม่ทราบชื่อ";
const subauthor1 = subauthor?.textContent ?? "ไม่ทราบชื่อผู้เเปล";
const subauthorplay1 = subauthorplay?.textContent ?? "ไม่ทราบชื่อผู้เเปล";
...
if (path.hostname == "anime-sugoi.com" || path.hostname.includes ("www.")) {
  if (document.location.pathname == "/") {
    ...
    presenceData.startTimestamp = browsingStamp;
    presenceData.details = "รับชม " + title1;
    presenceData.state = subauthorplay1;
  } else if (path.href) {
    presenceData.startTimestamp = browsingStamp;
