...
if (
	...
	switch (
		...
		case "Inovação & Gestão":
			...
			document.location.pathname.includes("/task")) {
		presenceData.details = document.querySelector("a.task-menu-header-info-title > h2").textContent;
		presenceData.state = document.querySelector("span.task-body-header-title-text").textContent;
