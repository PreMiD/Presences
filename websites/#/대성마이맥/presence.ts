...
presence.on("UpdateData", async () => {
  ...
  if (document.location.pathname.includes("/common/aquaplayer/")) {
    ...
    if (document.location.pathname === "/main/main.ds" || document.location.pathname === "/") 
    ...
    else if (document.location.pathname.includes("/myzone/orderDeliveryList.ds"))
      presenceData.details = "주문/배송조회";
    
    else if (document.location.pathname.includes("/myzone/mypage/mylctr/myLctrList.ds"))
      presenceData.details = "수강중인 강좌";
      
    else if (document.location.pathname.includes("/myzone/mypage/mylctr/detail/myStudyingCourseDetail.ds")) {
    ...
    } else if (document.location.pathname.includes("/myzone/mypage/mylctr/passPacLctrList.ds"))
      presenceData.details = "강좌 신청하기";

    else if (document.location.pathname.includes("/myzone/mypage/mylctr/bookPassList.ds"))
      presenceData.details = "교재 신청하기";
        
    else if (document.location.pathname.includes("/tcher/home/tcherHomeMain.ds"))
    ...
    else if (document.location.pathname.includes("/myzone/learningMng/learningPlan.ds"))
      presenceData.details = "학습 계획";

    else if (document.location.pathname.includes("/myzone/learningMng/learningReport.ds"))
      presenceData.details = "학습 리포트";

    else if (document.location.pathname.includes("/myzone/mypage/mylctr/detail/bookMarkList.ds"))
      presenceData.details = "북마크";

    else if (document.location.pathname.includes("/myzone/mypage/correct/useCorrectList.ds"))
