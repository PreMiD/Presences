  ...
  quora.on("UpdateData", async () => {
    ...
    if (document.location.hostname.match(/[A-Za-z]+.quora.com/)) {
      if (document.location.pathname == "/") {
        ...
        presenceData.startTimestamp = browsingStamp;
        taxonomy = document.querySelector(".qu-fontSize--xlarge > span:nth-child(1) > span:nth-child(1) > span:nth-child(1) > span:nth-child(1)").textContent;
        presenceData.details = "Viewing space:";
        presenceData.state = taxonomy;
      } else if (document.location.pathname.includes("/topic/")) {
        presenceData.startTimestamp = browsingStamp;
        taxonomy = document.querySelector(".qu-fontSize--xlarge > span:nth-child(1) > span:nth-child(1) > span:nth-child(1)").textContent;
        presenceData.details = "Viewing topic:";
        presenceData.state = taxonomy;
      } else if (document.location.pathname.includes("/profile/")) {
        presenceData.startTimestamp = browsingStamp;
        account = document.querySelector(".qu-ml--medium > div:nth-child(1) > div:nth-child(1) > span:nth-child(1)").textContent;
        presenceData.details = "Viewing profile:";
        presenceData.state = account;
      } else if (document.location.pathname.match(/^\/[A-Za-z0-9\%\-]+\/answer\//)) {
        presenceData.startTimestamp = browsingStamp;
        question = document.querySelector(".puppeteer_test_question_title > span:nth-child(1) > span:nth-child(1)").textContent;
        account = document.querySelector(".spacing_log_answer_header > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(1) > span:nth-child(1)").textContent;
        ...
        presenceData.startTimestamp = browsingStamp;
        question = document.querySelector("div.qu-bold:nth-child(2) > span:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > span:nth-child(1) > span:nth-child(1)").textContent;
