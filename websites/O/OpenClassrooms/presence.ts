...
presence.on("UpdateData", async () => {
    ...
    // Courses page
    else if(webpath === "/fr/courses" || webpath === "fr/courses/" || webpath.includes("/fr/search") || webpath.includes("/en/search")) {
    ...
    // Reading a course
        ...
        if(document.body.contains(document.getElementsByClassName("breadcrumb__item")[3])) {
        ...
        else if(!document.body.contains(document.getElementsByClassName("breadcrumb__item")[3])) {
