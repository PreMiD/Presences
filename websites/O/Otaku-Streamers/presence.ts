...
presence.on("UpdateData", async () => {
    ...
    if(window.location.hostname == "otaku-streamers.com"){
        ...
        if(path == "/" || path == "/index.php"){
            ...
            title = (document.querySelector("tr > td:nth-child(2) > span") as HTMLTextAreaElement);
            if(title){
            ...
            title = (document.querySelector("#strw_player > table > tbody > tr:nth-child(1) > td > span:nth-child(1) > a") as HTMLTextAreaElement);
        ...
        if(path == "/" || path == "/index.php" || path == "/#"){
            ...
            title = (document.querySelector("#main > div.title-box > h4 > u") as HTMLTextAreaElement);
            presenceData.startTimestamp = browsingStamp;
            if(title){
                presenceData.details = "Viewing:";
                presenceData.state = title.innerText;
            ...
            title = (document.querySelector("div.album-top-box.mb-4.text-left > h1") as HTMLTextAreaElement);
            presenceData.startTimestamp = browsingStamp;
            if(title){
                presenceData.details = "Viewing:";
                presenceData.state = title.innerText;
            ...
            title = (document.querySelector("div.title-box > h4 > a") as HTMLTextAreaElement);
            if(title){
            ...
            title = (document.querySelector("#main > div.master-container-fluid > div.row.justify-content-between > div.col-xl-7.text-center.text-md-left > h1 > span") as HTMLTextAreaElement);
            presenceData.startTimestamp = browsingStamp;
            if(title){
