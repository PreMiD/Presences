...
const KNOWN_LANGUAGES: { language: string; image: string }[] = [
	...
	KNOWN_EXTENSIONS: { [key: string]: { image: string } } = {
		...
		"/\\.eslint((rc|ignore)|(\\.(json|js))?$){2}/i": { image: "eslint" },
		"/\\prettier.config.js/i": { image: "prettier" },
		"/vue.config\\.(js|ts)/i": { image: "vueconfig" },
		"/vite.config\\.(js|ts)/i": { image: "viteconfig" },
		"/vitest.config\\.(js|ts|mjs)/i": { image: "vitestconfig" },
		"/jest.config\\.(js|ts)/i": { image: "jest" },
