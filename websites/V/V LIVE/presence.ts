	...
	return presence.getStrings(
		{
			...
			browseThrough: "vlive.browseThrough",
			newVid: "vlive.newVid",
			charts: "vlive.charts",
			upcoming: "vlive.upcoming",
			channelList: "vlive.channelList",
			events: "vlive.events",
			store: "vlive.store",
			recentUploads: "vlive.recentUploads",
			ofChannel: "vlive.ofChannel",
			channelHome: "vlive.channelHome",
			channelSchedule: "vlive.channelSchedule",
			channelMy: "vlive.channelMy",
			channelStore: "vlive.channelStore",
			channelBoard: "vlive.channelBoard",
			product: "vlive.product",
			profileEdit: "vlive.profileEdit",
			viewTheir: "vlive.viewTheir",
			profile: "vlive.profile",
			watched: "vlive.watched",
			purchases: "vlive.purchases",
			coins: "vlive.coins",
			devices: "vlive.devices",
			followed: "vlive.followed",
			policies: "vlive.policies",
		},
