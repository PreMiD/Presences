...
presence.on("UpdateData", async function () {
	...
	if (/[a-z]{2}(-)[A-Z]{2}/g.test(urlpath[1]) && !urlpath[2])
		...
		switch (urlpath[3]) {
			...
			case "bikes":
				...
				if (document.getElementById("chakra-modal-register-bike"))
		...
		if (urlpath[3]) {
			if (urlpath[3] === "media_kits") presenceData.state = "Media";
			else if (urlpath[3] === "about") presenceData.state = "About Us";
			else if (urlpath[3] === "contact") presenceData.state = "Contact Us";
			else {
