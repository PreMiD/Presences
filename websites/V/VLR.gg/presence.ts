const presence = new Presence({
	...
	teamicon: HTMLImageElement = document.querySelector(
		".wf-avatar.team-header-logo img"
	),
	eventicon: HTMLImageElement = document.querySelector(
		".wf-avatar.event-header-thumb img"
	),
	playername: HTMLElement = document.querySelector(
		".player-real-name.ge-text-light"
	);
