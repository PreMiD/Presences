  ...
  if (incognito === false) {
    if (
      ...
      if (hasMeta('smallImageText')) {
        presenceData.smallImageText = strings.smallImageText || getMeta('smallImageText')
      }
      ...
      presenceData.smallImageKey = 'https://cdn.rcd.gg/PreMiD/websites/V/Void%20Bots/assets/0.png'
