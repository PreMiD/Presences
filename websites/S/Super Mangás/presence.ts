...
presence.on('UpdateData', async() => {
    ...
    const comentario: HTMLElement = document.querySelector("#corpo > div.conteudoBox.commentBoxAncora > div.commentMain > div.js_comment_view_box");
    const nome: HTMLElement = document.querySelector("div.boxBarraInfo > h1");
    const infoDiv: HTMLElement = document.querySelector("body > div.js_viewCliente");
    const infoDivTitulo: HTMLElement = document.querySelector("body > div.js_viewCliente > div > p");
    const paginaCapitulo: HTMLSelectElement =  document.querySelector("#corpo > div.conteudoBox.box_suport > div.capBox > div > div.capMenu.capMenuFixedTop > select.capListPage");
    ...
    const nomeidentificadorPerfil: HTMLElement = document.querySelector("#corpo > div.conteudoBox > h1");
    ...
    const formatoObra: HTMLElement = document.querySelector("#corpo > div:nth-child(1) > div:nth-child(2) > div.boxAnime > ul > li:nth-child(2)");
    if (path == '/') {
        ...
        presenceData.state = 'No(a) ' + topCategorizar.textContent.slice(topCategorizar.textContent.search('Top 100-') + 10);
