...
presence.on("UpdateData", async () => {
  ...
  if (
    ...
    if (queryparams.get("preset") === "discount")
      ...
      if (queryparams.get("preset").match(vowelmatch)) {
        presenceData.details = `Searching for an ${queryparams.get(
          "preset"
        )} game`;
      } else {
        presenceData.details = `Searching for a ${queryparams.get(
          "preset"
        )} game`;
      }
    } else {
  ...
  else presenceData.details = "Currently somewhere unknown";
