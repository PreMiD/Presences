...
presence.on("UpdateData", async () => {
  ...
  else if (path === "/sociology/") subjectCondition("sociology");
  else if (path === "/poetry/") subjectCondition("poetry");
  else if (path === "/drama/") subjectCondition("drama");
  else if (path === "/cs/") {
    subject = "cs";
    title = document.querySelector(
      "body > header.TitleHeader_header.TitleHeader_header--studyGuide > div > div > h1"
  ...
  } else if (path === "/health/") subjectCondition("health");
  else if (path === "/physics/") subjectCondition("physics");
  else if (path === "/biography/") subjectCondition("biography");
  else if (path === "/economics/") subjectCondition("economics");
  else if (path === "/history/") subjectCondition("history");
  else if (path === "/philosophy/") subjectCondition("philosophy");
  else if (path === "/psychology/") subjectCondition("psychology");
