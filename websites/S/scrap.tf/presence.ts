...
presence.on("UpdateData", async () => {
  ...
  if (document.location.pathname === "/")
    presenceData.details = "Viewing Main page";
    else if (document.location.pathname.includes("/stats")) presenceData.details = "Viewing the site stats", presenceData.state = "Trade-stats for the past 12 hours";
    else if (document.location.pathname.includes("/partswap")) presenceData.details = "MvM Part Swap", presenceData.state = "Trading MvM Parts";
    else if (document.location.pathname.includes("/itemvalues")) presenceData.details = "Checking Item Values for Premium";
    else if (document.location.pathname.includes("/games")) presenceData.details = "Steam Game Trading", presenceData.state = "Viewing the games price info";
    else if (document.location.pathname.includes("/tips")) presenceData.details = "Viewing Tips page";
    else if (document.location.pathname.includes("/twitch")) presenceData.details = "Getting more information about", presenceData.state = "Scrap.TF Twitch Raffle Bot";
    else if (document.location.pathname.includes("/support")) presenceData.details = "Viewing Live Support page";
    else if (document.location.pathname.includes("/inventory")) presenceData.details = "Viewing thier site inventory";
    else if (document.location.pathname.includes("/deposit")) presenceData.details = "Depositing items into their site inventory";
    else if (document.location.pathname.includes("/devices")) presenceData.details = "Generating a new key for Scrap.tf chat service";
    else if (document.location.pathname.includes("/search")) presenceData.details = "Searching for an item";
    else if (document.location.pathname.includes("/notices")) presenceData.details = "Viewing all of their notifications";
    else if (document.location.pathname.includes("/collection")) presenceData.details = "Viewing their profile collection";
      ...
      if (document.location.pathname.includes("/history")) {
        const title = document.querySelector("#pid-viewmegaraffle > div.bots-container.flat-slate > div > div.megaraffle-summary > span");
      ...
      const title = document.querySelector("#dynamic-height-slate > div > div > div.col-md-9 > div > div > div.profile-upper > div.rev-banking-background.profile-background > div > div.profile-summary.col-md-6 > h1 > span > span");
      const perm = document.querySelector("#dynamic-height-slate > div > div > div.col-md-9 > div > div > div.profile-upper > div.rev-banking-background.profile-background > div > div.profile-summary.col-md-6 > h3 > b");
      ...
      const title = document.querySelector("#dynamic-height-slate > div > div.panel-body > p:nth-child(1) > small");
      presenceData.details = "Reading ToS";
      presenceData.state = title.textContent;
    } else if (document.location.pathname.includes("/premium")) {
      const title = document.querySelector("#premium-balance").innerText.replace("You've Donated ", " ");
      ...
      const sellp = document.querySelector("#pid-keys > div.welcome > div > div > div.col-md-9.bank-welcome.keys-welcome > h3:nth-child(2) > span");
      ...
      else if (document.location.pathname.includes("/items")) presenceData.state = "Trading with Items";
      else if (document.location.pathname.includes("/stranges")) presenceData.state = "Trading with Stranges";
      else if (document.location.pathname.includes("/killstreaks")) presenceData.state = "Trading with Killstreak Kits";
      else if (document.location.pathname.includes("/gifts")) presenceData.state = "Trading with Steam Games";
      else if (document.location.pathname.includes("/cards")) presenceData.state = "Trading with Steam Trade Cards";
      else if (document.location.pathname.includes("/skins")) presenceData.state = "Trading with Warpaints/Skins";
      else if (document.location.pathname.includes("/unusuals")) presenceData.state = "Trading with Unusuals";
      else if (document.location.pathname.includes("/incinerator")) presenceData.state = "Incinerating Items FOR FREE!";
      else if (document.location.pathname.includes("/all")) presenceData.state = "Choosing items from the entire backpack";
    }

    else if (document.location.pathname.includes("/buy")) {
      if (document.location.pathname.includes("/weapons")) presenceData.details = "Buying Weapons";
      else if (document.location.pathname.includes("/hats")) presenceData.details = "Buying Hats";
      else if (document.location.pathname.includes("/items")) presenceData.details = "Buying Items";
      else if (document.location.pathname.includes("/stranges")) presenceData.details = "Buying Stranges";
      else if (document.location.pathname.includes("/killstreaks")) presenceData.details = "Buying Killstreak Kits";
      else if (document.location.pathname.includes("/gifts")) presenceData.details = "Buying Steam Games";
       ...
       if (document.location.pathname.includes("puzzle")) {
      ...
      } else if (document.location.pathname.includes("create")) presenceData.details = "Creating a Raffle";
      else if (document.location.pathname.includes("history")) {
        const title = document.querySelector("#dynamic-height-slate > div > div.panel-body.raffle-header-border > div > div > h1");
        ...
        const title = document.querySelector("#dynamic-height-slate > div > div.panel-body.raffle-header-border > div > div > h1");
        const item = document.querySelector("#dynamic-height-slate > div > div.panel-body.raffle-header-border > div > div:nth-child(2) > h1");
        if (document.location.pathname.includes("/public")) {
        ...
        const title = document.querySelector("#main-container > div > div.well.raffle-well > div:nth-child(1) > h3");
        presenceData.details = "Visiting a raffle page";
        presenceData.state = `"${title.textContent}"`;
      } else {
        const re = document.querySelector("#main-container > div.panel.panel-info > div.panel-body.raffle-list-body > div.raffle-list-header > div:nth-child(2) > h1");
        const rw = document.querySelector("#main-container > div.panel.panel-info > div.panel-body.raffle-list-body > div.raffle-list-header > div:nth-child(3) > h1");
      ...
      if (document.location.pathname.includes("/create")) presenceData.details = "Creating an Automated Auction";
        ...
        const title = document.querySelector("#dynamic-height-slate > div > div.panel-body.text-center").innerText.replace("You have won a total of " , " ");
        ...
        const title = document.querySelector("#main-container > div > div.well.auction-well > div:nth-child(1) > h3");
        presenceData.details = "Viewing an Auction page";
        presenceData.state = `"${title.textContent}"`;
      } else {
        const title = document.querySelector("#main-container > div:nth-child(2) > div.panel-body > div.text-center").innerText.replace(" Steam API Availability: 100%\n" , " ");
