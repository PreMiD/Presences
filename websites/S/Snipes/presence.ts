...
presence.on("UpdateData", async function () {
  ...
  if (!urlpath[1]) presenceData.details = "Home";
    ...
    } else if (urlpath[2] === "sale") presenceData.details = "Sale";
    else if (urlpath[2] === "deals") presenceData.details = "Deals";
    else if (urlpath[2] === "musthaves") presenceData.details = "Must haves";
    else if (
  ...
  } else if (urlpath[1] === "view-account") presenceData.details = "Account";
  else if (urlpath[1] === "edit-account")
    presenceData.details = "Editing account";
  else if (urlpath[1] === "cliqueoverview") presenceData.details = "Clique";
  ...
  else if (urlpath[1] === "wishlist") presenceData.details = "Wishlist";
  else if (urlpath[1] === "cart") presenceData.details = "Shopping cart";
  else if (urlpath[1] === "addresses") presenceData.details = "Addresses";
  ...
  else if (urlpath[1] === "login") presenceData.details = "Login";
  else if (urlpath[1] === "registration") presenceData.details = "Register";
  else if (urlpath[1] === "storefinder") presenceData.details = "Storefinder";
  else if (urlpath[1] === "content") presenceData.details = "Other";
