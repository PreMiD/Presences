let const = new Presence({clientId: "704186478410072065"});
...
presence.on("UpdateData", async () => {
    ...
    } else if (document.querySelector("p.now-playing-info-label__text").textContent === "On Air Show") {
    ...
    } else if (document.querySelector("p.now-playing-info-label__text").textContent === "Xtra Channel") {
        channelName = document.querySelector("p.channel-name");
        songName = document.querySelector("span.track-name");
        songArtist = document.querySelector("span.artist-name");
    ...
    } else if (document.querySelector("p.now-playing-info-label__text").textContent === "On Demand Episode") {
    ...
    } else if (document.querySelector("p.now-playing-info-label__text").textContent === "Pandora Station") {
        channelName = document.querySelector("p.channel-name");
        songName = document.querySelector("span.track-name");
        songArtist = document.querySelector("span.artist-name");
