...
presence.on("UpdateData", async () => {
  ...
  if (document.location.hostname == "spiderum.com") {
    ...
    if (document.location.pathname.includes("/bai-dang/viet-bai") || (document.location.pathname.includes("/bai-dang/viet-tiep/"))) {
      ...
      presenceData.state = document.querySelector(".display-name").textContent + " (" + document.querySelector(".nickname").textContent + ")";
    } else if (document.location.pathname.includes("/s/all/")) {
      presenceData.details = "Đang xem:";
      presenceData.state = "Tất cả bài viết";
      presenceData.smallImageKey = "read";
    } else if (document.location.pathname.includes("/s/quan-diem-tranh-luan/")) {
      presenceData.details = "Đang xem danh mục:";
      presenceData.state = document.querySelector("#category-heading > div.text-box > div.title").textContent;
      presenceData.smallImageKey = "read";
      ...
      presenceData.state = "Cần cù thì bù siêng năng, chỉ có làm thì mới có ăn :(";
      presenceData.smallImageKey = "read";
    }
  }
