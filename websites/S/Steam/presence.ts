          ...
          case "profiles": {
            if (
              ...
              const pfname =
                ...
                HTMLAnchorElement >
                "#responsive_page_template_content > div > div.profile_small_header_bg > div > div > span.profile_small_header_name > a"?.textContent.trim();
              if (
                pathname.includes("/badges") ||
                pathname.includes("/gamecards")
              )
              ...
              const pfname =
                document.querySelector <
                HTMLAnchorElement >
                "#HeaderUserInfoName > a".textContent;
              ...
              presenceData.state = `Viewing ${
                document.querySelector <
                HTMLTitleElement >
                "head > title".textContent.replace("Steam Community :: ", " ")
              }'s profile`;
            ...
            if (pathname.includes("/workshop/")) {
              ...
              if (pathname.includes("/0/")) {
                ...
                presenceData.state =
                  document.querySelector <
                  HTMLTitleElement >
                  "head > title".textContent.replace(
                    " :: Steam Community",
                    " "
                  );
                presenceData.startTimestamp = browsingTimestamp;
        ...
        switch (pathArray[1]) {
          ...
          case "developer": {
            ...
            presenceData.state =
              document.querySelector <
              HTMLTitleElement >
              "head > title".textContent.replace("Steam Developer: ", " ");
            presenceData.startTimestamp = browsingTimestamp;
            presenceData.buttons = [
              {
                label: "View the page",
          ...
          case "publisher": {
            ...
            presenceData.state =
              document.querySelector <
              HTMLTitleElement >
              "head > title".textContent.replace("Steam Publisher: ", " ");
            presenceData.startTimestamp = browsingTimestamp;
            presenceData.buttons = [
              {
                label: "View the page",
          ...
          case "franchise": {
            ...
            presenceData.state =
              document.querySelector <
              HTMLTitleElement >
              "head > title".textContent.replace("Steam Franchise: ", " ");
            presenceData.startTimestamp = browsingTimestamp;
            presenceData.buttons = [
              {
                label: "View the page",
