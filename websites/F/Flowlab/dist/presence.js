const flowlabPresence = new Presence({ clientId: "991160367629750372" }), flowlabTimestamp = Math.floor(Date.now() / 1000);
flowlabPresence.on("UpdateData", async () => {
    ...
    if (presenceData.details)
        flowlabPresence.setActivity(presenceData);
    else
        flowlabPresence.setActivity();
});
