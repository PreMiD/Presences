...
presence.on("UpdateData", async () => {
  ...
  if (privacy) {
    ...
    } else if (window.location.pathname.includes('outils-et-objets-dans-minecraft.php')) {
      presenceData.details = "Viewing a page:";
      presenceData.state = "Minecraft Items";
    } else if (window.location.pathname.includes("item-")) {
      if (document.querySelector("#popup > h3").textContent.includes('Minage du bloc')) presenceData.details = "Viewing a minecraft block:";
      else presenceData.details = "Viewing a minecraft item:";
    ...
    } else if (window.location.pathname.includes('creatures-mobs-animaux-sur-minecraft.php')) {
      presenceData.details = "Viewing a page:";
    ...
    } else if (window.location.pathname.includes('codes-couleur-minecraft.php')) {
      presenceData.details = "Viewing a page:";
