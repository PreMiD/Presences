  ...
  return presence.getStrings(
    {
      ...
      cookies: "premid.pageCookies",
      privacy: "premid.pagePrivacy",
      terms: "premid.pageTerms",
      ...
      incident: "premid.incidentHistory",
      uptime: "premid.uptimeHistory",
