...
const club = document.querySelector("#main-body-content > div.content > div.container-wrap.bottombdr.bottomspc > div > div > ul > li");
//Changer
...
// Presence
if (path.hostname == "pantip.com" || path.hostname.includes ("([a-z0-9-]+[.])*")) {
  if (document.location.pathname == "/") {
    ...
    presenceData.startTimestamp = browsingStamp;
    const search = document.getElementById("search-text").getAttribute("value") ?? "ไม่ทราบการค้นหา";
