...
if (path === "/") {
  ...
  testActive = document.querySelector('#words letter.correct') || document.querySelector('#words letter.incorrect'),
  lbVisible = !document.querySelector('#leaderboardsWrapper').classList.contains('hidden');
  if(resultPageVisible){
    ...
    testType = document.querySelector('.pageTest #premidTestMode').textContent,
    wpm = document.querySelector('.pageTest #largeLiveWpmAndAcc #liveWpm').textContent,
    acc = document.querySelector('.pageTest #largeLiveWpmAndAcc #liveAcc').textContent;
