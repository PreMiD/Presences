...
if (document.location.pathname === "/")
    ...
    presenceData.state = `${document
        ...
        .replace(" - Definition and More from the Free Merriam-Webster Dictionary", "")}`;
    ...
    presenceData.state = `${document
        .querySelector("head > title").textContent
        .replace(" | Merriam-Webster Games And Quizzes", "")
    ...
    presenceData.state = `${document
        .querySelector("head > title").textContent
        .replace(" | Reviews by Merriam-Webster", "")}`;
    presenceData.buttons = [
        {
            label: "View Review",
            url: location.href,
    ...
    presenceData.state = `${word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()}`;
    presenceData.buttons = [
        {
            label: "View Page",
            url: location.href,
	...
	presenceData.state = `${document
		.querySelector("head > title").textContent
        .replace(": Browse the Dictionary | Merriam-Webster", "")}`;
    presenceData.buttons = [
        {
            label: "View Page",
            url: location.href,
    ...
    presenceData.state = `${document
        .querySelector("head > title").textContent
        .replace(" Definition & Meaning | Merriam-Webster Legal", "")}`;
    presenceData.buttons = [
        {
            label: "View Page",
            url: location.href,
	...
	presenceData.state = `${document
		.querySelector("head > title").textContent
        .replace(" Definition & Meaning | Merriam-Webster Medical", "")}`;
    presenceData.buttons = [
        {
            label: "View Page",
            url: location.href,
