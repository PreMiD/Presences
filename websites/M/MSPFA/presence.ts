...
presence.on("UpdateData", async () => {
  ...
  switch (document.location.pathname) {
    ...
    case "/user/":
      // (A) user Profile
      presenceData.state = "User: " + document.querySelector("h2#username").innerHTML;
      break;
    ...
    case "/my/stories/pages/":
      // See above
      presenceData.smallImageKey = "writing";
      presenceData.state = document.querySelector("a#storyname.major").innerHTML;
      break;
    case "/achievements/":
      // Typescript yelled at me when I tried to use innerText
      presenceData.state = "User: " + document.querySelector("a#username").innerHTML;
      break;
    case "/log/":
      // See above
      presenceData.state = document.querySelector("a#storyname.major").innerHTML;
  ...
  } else if (document.location.pathname === "/" && document.location.search !== "") {
    // Adventures
