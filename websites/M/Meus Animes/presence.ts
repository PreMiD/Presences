...
const filtroObraAnime: HTMLElement = document.querySelector(
...
const numeroEpisodio: HTMLElement = document.querySelector(
...
const pesquisaTitulo: HTMLElement = document.querySelector(
