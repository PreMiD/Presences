...
presence.on("UpdateData", async () => {    
  ...
  //Serien
          ...
          const chapter = document.querySelector("body > div.blur-content > div > div.reader-navigation > div.container > div.pages-control > div.dropdown.chapter-dropdown > ul > li.active > a").textContent.replace('Seite', "Kapitel"),
          ...
          const serieslist = document.querySelector("head > title").textContent.split("- Manga-Tube")[0];
