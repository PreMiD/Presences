...
presence.on("UpdateData", async () => {    
    ...
    //Serien
            ...
            form = document.querySelector("body > div.blur-content > div.wraper > div > div > div.content-container > div.row > div.col-md-8.series-detailed > div.row > div.col-md-8.col-sm-8.col-offest-xs-2.col-xs-12 > ul > li:nth-child(5) > a").textContent.split("(japanische Comics)")[0];
            data.details = "| " + form;
            data.state = manga;
