...
presence.on("UpdateData", async () => {
    ...
    if (document.location.pathname == "/") {
        ...
        const chapter = document.querySelector("body > div.blur-content > div > div.reader-navigation > div.container > div.pages-control > div.dropdown.chapter-dropdown > button").textContent, browsingStamp = Math.floor(Date.now() / 1000), manganame = document.querySelector("head > title").textContent.split("- Kapitel ")[0], seite = document.querySelector("body > div.blur-content > div > div.reader-navigation > div.container > div.pages-control > div.dropdown.page-dropdown > button > span.page-text").textContent;
        ...
        const manga = document.querySelector("body > div.blur-content > div.wraper > div > div > div.content-container > div.row > div.col-md-8.series-detailed > h1").textContent, form = document.querySelector("body > div.blur-content > div.wraper > div > div > div.content-container > div.row > div.col-md-8.series-detailed > div.row > div.col-md-8.col-sm-8.col-offest-xs-2.col-xs-12 > ul > li:nth-child(5) > a").textContent.split("(japanische Comics)")[0];
        data.details = "| " + form;
        data.state = manga;
    }
        ...
        const profile = document.querySelector("#profile > div.profile-header.hide-md > div > div.profile-header-content > div.col-md-10.col-xs-8 > h4.profile-username.pull-left > b").textContent, level = document.querySelector("#user_level").textContent;
        data.details = "| Profil";
