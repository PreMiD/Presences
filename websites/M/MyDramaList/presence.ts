...
presence.on("UpdateData", async () => {
    if(document.location.pathname == "/") {
        ...
        let searchThing = decodeURIComponent(document.location.search.substring(3)).replace(/\+/g, " ");
        ...
        if(document.location.pathname.startsWith("/profile/")) {
           let profileName1 = document.querySelector("#content > div > div.container-fluid.profile-container > div > div.col-lg-8.col-md-8 > div.box > div.box-header.box-navbar > div.profile-header > div.hidden-sm-down > h1");
           ...
           presence.setActivity(profilePresnceData);
            ...
            let actorsName = document.querySelector("#content > div > div.container-fluid > div > div.col-lg-4.col-md-4 > div > div:nth-child(1) > div.box-header.p-b-0.text-center > h1");
            ...
            let showName = document.querySelector("div.col-lg-8.col-md-8.col-right > div:nth-child(1) > div.box-header.box-navbar > h1 > a");
        ...
        let articleName = document.querySelector("#article > div.box-header > h1 > a").textContent;
        ...
        */
        const profileName = document.querySelector("#content > div > div.container-fluid.profile-container > div > div.col-lg-8.col-md-8 > div.box > div.box-header.box-navbar > div.profile-header > div.hidden-sm-down > h1");
