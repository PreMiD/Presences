...
presence.on('UpdateData', async () => {
    ...
    tipoobra: HTMLElement = document.querySelector("body > div.wrap > div > div > div > div.profile-manga > div > div > div > div.tab-summary > div.summary_content_wrap > div > div.post-content > div:nth-child(9) > div.summary-content"),
    primeirogeneroobra: HTMLElement = document.querySelector("body > div.wrap > div > div > div > div.profile-manga > div > div > div > div.tab-summary > div.summary_content_wrap > div > div.post-content > div:nth-child(8) > div.summary-content > div > a:nth-child(1)"),
    filtroprojetos: HTMLElement = document.querySelector("body > div.wrap > div > div > div.c-page-content.style-1 > div > div > div > div > div.main-col-inner > div > div.c-page__content > div.tab-wrap > div > div.c-nav-tabs > ul > li.active"),
    pesquisatexto: HTMLInputElement = document.querySelector("body > div.wrap > div > div > div.c-search-header__wrapper > div > div.search-content > form > input.search-field.manga-search-field.ui-autocomplete-input"),
    paginaLogin: HTMLElement = document.querySelector("#post-8 > div.entry-content > div > div > div.col-md-3.col-sm-3 > div > ul > li.active"),
