...
if (privacy){
  ...
  if (document.location.pathname == "/") {
    ...
    presenceData.state = document.querySelector ("#content > div.song_title.g_rblock > div.right > h2.mode > span:nth-child(2)").textContent;
    presenceData.startTimestamp = browsingStamp;
    presenceData.buttons = [
     {
          label: "View Chart",
    ...
    if (document.location.pathname.includes ("/topic")) {
      ...
      presenceData.details = "Viewing topic: " + document.querySelector("#chead > div > a").textContent;
      presenceData.state = document.querySelector("#g_talk > div.g_talk_title > p > span").textContent;
    ...
    presenceData.smallImageKey = "edit";
    presenceData.details = document.querySelector("#content > div.g_title").textContent + " Profile";
    presenceData.startTimestamp = browsingStamp;
