...
presence.on("UpdateData", async () => {
	...
	if(document.getElementById('itemName')) {
		presenceData.largeImageKey = (<HTMLImageElement>document.getElementById("itemImage")).src

		presenceData.details = `Viewing ${document.getElementById('itemName').innerHTML}`

		if(document.getElementById('itemDescription')) {
			presenceData.state = `${document.getElementById('itemDescription').innerHTML}`
		}
