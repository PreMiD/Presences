...
presence.on('UpdateData', async () => {
  const [info, elapsed, format1, format2, format3, buttons, logo] = await Promise.all([
  ...
  if (
    ...
    if (
      ...
      let track: string | null | undefined, artist: string | null | undefined, cover: string | null | undefined
