...
const presenceData = {
  ...
  function showUsername() {
    return (set_showUsername ? ` | User: ${document.querySelector("#RPC_Username").textContent}` : "");
  }
if (
  ...
  if (
    ...
    presenceData.details =
      "Startseite" + showUsername();
  } else if (document.location.pathname.includes("/login")) {
    presenceData.details =
      "Meldet sich an" + showUsername();
  } else if (document.location.pathname.includes("/register")) {
    presenceData.details =
      "Registriert sich" + showUsername();
