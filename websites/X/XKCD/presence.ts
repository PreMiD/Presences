...
presence.on('UpdateData', () => {
  ...
  if (
    ...
    && !Number.isNaN(Number(location.pathname.replace(/\//g, '')))
  ) {
    ...
    presenceData.smallImageKey = 'https://cdn.rcd.gg/PreMiD/websites/X/XKCD/assets/0.png'
    ...
    presenceData.details = 'Browsing XKCD'
  }
