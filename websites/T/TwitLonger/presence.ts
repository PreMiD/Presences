...
if (document.location.pathname == "/") {
  ...
  let postTitle = (document.querySelector("#postcontent > h3")as HTMLElement).innerText;
  let userName = (document.querySelector("#user-info > div > h4 > a:nth-child(1)")as HTMLElement).innerText;
  let userHandle = (document.querySelector("#user-info > div > h4 > a:nth-child(2)")as HTMLElement).innerText;
   presenceData.startTimestamp = browsingStamp;
