...
presence.on("UpdateData", () => {
  ...
  if (
    window.location.href.toLowerCase().includes("www.movenowthinklater.com")
  ) {
    presenceData.state = "www.movenowthinklater.com";
  }
  if (
    window.location.href.toLowerCase().includes("www.partridgegetslucky.com")
  ) {
  ...
  if (
    window.location.href.toLowerCase().includes("www.muchbetterthanthis.com")
  ) {
