...
presence.on("UpdateData", async () => {
  ...
  else if (pathname.startsWith("/filmes")) presenceData.state = "Filmes";
  else if (pathname.startsWith("/series")) presenceData.state = "Séries";
  else if (pathname.startsWith("/favoritos")) presenceData.state = "Favoritos";
