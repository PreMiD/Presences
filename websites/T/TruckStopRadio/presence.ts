...
dj = document.querySelector("#root > div:nth-child(3) > div > div:nth-child(2) > div > h4") as HTMLElement;
...
presence.on("UpdateData", async () => {
  ...
  title = document.querySelector("#root > div:nth-child(3) > div > div > div > h2");
  artist = document.querySelector("#root > div:nth-child(3) > div > div > div > h4");
