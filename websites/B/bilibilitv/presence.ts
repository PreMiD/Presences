...
} else if (path.startsWith("/th/play")) {
  ...
  presenceData.buttons = [
    {
      ...
      url: `https://www.bilibili.tv/th/play/${urlpath[3]}`
    }
  ];
} else if (path.startsWith("/th/video")) {
  presenceData.smallImageKey = "play";
  ...
  presenceData.buttons = [
    {
      ...
      url: `https://www.bilibili.tv/th/video/${urlpath[3]}`
    }
  ];
} else if (path.startsWith("/th/space")) {
