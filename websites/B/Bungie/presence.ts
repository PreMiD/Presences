...
presence.on("UpdateData", async () => {
  ...
  if (path === "/7/en/Destiny/NewLight")
    ...
    presenceData.details = `Reading ${
      document.querySelector("#article-container > h1").innerHTML
    }`;
    ...
    presenceData.details = `Helpful ${
      document.querySelector("#searchValue").innerHTML
    }`;
    ...
    presenceData.details = `Reading ${
      document.querySelector("#guide-container > div.header > h1").innerHTML
    }`;
