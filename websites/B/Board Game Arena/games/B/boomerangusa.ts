...
const boomerangusa: GamePresence = {
	...
	"description": "Waiting for others players to choose a national activities to score",
	"descriptionmyturn": "You may choose an activity to score this round or pass.",
	"type": "multipleactiveplayer",
	"action": "st_MultiPlayerInit",
	"args": "argChooseactivities",
	"updateGameProgression": true,
	"possibleactions": [
		"selectactivities",
