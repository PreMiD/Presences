...
const solo: GamePresence = {
	logo: "https://cdn.rcd.gg/PreMiD/websites/B/Board%20Game%20Arena/assets/499.png",
		...
		if (activePlayer === userPlayer || gameStateType !== "activeplayer") {
			switch (gameState) {
				...
				case "playerChoosePlayer":
					data.state = "Exchanging cards with another player";
					break;
				case "playerHasToDraw":
					data.state = "Drawing cards";
					break;
				case "playerTurnAfterDraw":
					data.state = "Playing a card or passing";
					break;
				case "gameEnd":
