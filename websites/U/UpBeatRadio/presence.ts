...
presence.on("UpdateData", async () => {
  ...
  if (info) {
    ...
    if (document.querySelector("#modalrequestFormModal") !== null) {
      presenceData.details = "Sending in a request...";
      presenceData.smallImageKey = "writing";
    } else if (document.querySelector("#modalundefined") !== null) {
      presenceData.details = "Sending in feedback...";
      presenceData.smallImageKey = "writing";
    } else if (document.querySelector("#modaldjAppButton") !== null) {
      presenceData.details = "Applying for:";
      presenceData.state = "Radio Presenter";
      presenceData.smallImageKey = "writing";
    } else if (document.querySelector("#modalmediaAppButton") !== null) {
      presenceData.details = "Applying for:";
      presenceData.state = "News Reporter";
      presenceData.smallImageKey = "writing";
    } else if (document.querySelector("#accountBio") !== null) {
      presenceData.details = "Editing their bio";
      presenceData.smallImageKey = "writing";
    } else if (document.querySelector("#modalcontactUsButton") !== null) {
      presenceData.details = "Sending in a";
      presenceData.state = "general enquiry";
      presenceData.smallImageKey = "writing";
    } else if (document.querySelector("#modalpartnerEnquiryButton") !== null) {
      presenceData.details = "Sending in a";
