...
presence.on("UpdateData", async () => {
  ...
  if (
    ...
    else if (path.includes("podminky-uziti")) presenceData.details = "Podmínky užití";
    else if (path.includes("ochrana-osobnich-udaju")) presenceData.details = "GDPR";
  ...
  } else if (path.includes("editor/novy")) presenceData.details = "Píše nový článek";
    else if (path === "/forum") {
    presenceData.details = "Fórum";
  ...
  } else if (path === "/forum/43") presenceData.state = "Chystá se způsobit adminům deprese.";
   else if (path.includes("/newtopic")) presenceData.details = "Zakládá nové téma";
    ...
    else if (path.includes("index.php")) presenceData.state = "Odvařuje si mozek";
