...
presence.on("UpdateData", () => {
  ...
  if (document.location.pathname.startsWith("/skins"))
    ...
    presenceData.buttons = [
      {
          label: "View " + document.querySelector("div.col-12>h1")?.textContent + "'s profile",
    ...
    presenceData.buttons = [
      {
          label: "View " + document.querySelector("div.mb-1>h1")?.textContent + " cape",
          url: window.location.href
      }
    ];
    ...
    presenceData.buttons = [
      {
          label: "View " + document.querySelector("div.mb-1>h1")?.textContent + " badge",
          url: window.location.href
      }
    ];
