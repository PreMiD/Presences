...
presence.on("UpdateData", async () => {
	...
	if (document.querySelector(".pdp-mod-product-badge-title")) {
		...
		presenceData.state = item.textContent;
	} else if (document.location.pathname.includes("/customer/order")) {
		// ORDER
	...
	} else if (document.location.pathname.includes("/user/profile")) {
		// PROFILE
		item = document.querySelector(".my-profile-item-info");
		presenceData.details = "My Profile:";
		presenceData.state = item.textContent;
	} else if (document.location.pathname.includes("/address")) {
		// ADDRESS
		...
		document.location.pathname.includes("/customer/cancellations/index")
	) {
		// CANCALLATIONS
		presenceData.details = "My Cancellations";
	} else if (
		document.location.pathname.includes("customer/cancellations/view")
	) {
	...
	} else if (document.location.pathname.includes("/customer/myReview")) {
		// CANCELLATION DETAILS
	...
	} else if (document.location.pathname.includes("/customer/returns")) {
		// RETURNS
