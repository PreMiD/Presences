...
export const logo = 'https://cdn.rcd.gg/PreMiD/websites/J/Jackbox/assets/23.png'
...
export function getPresenceData({
  ...
  if (icon) {
    presenceData.smallImageKey = getComputedStyle(icon).backgroundImage.match(/^url\("(.*)"\)$/)?.[1]
  }
