...
=======
        else if (urlpath[1] != 'play' && (document.location.pathname.includes("/serien") || document.location.pathname.includes("/filme") || document.location.pathname.includes("/sport")) || urlpath[1] == "compilation") {
                presenceData.details = "Durchstöbert";
        }
        else if (urlpath[1] == 'channels') {
            presenceData.details = 'Durchstöbert';
            ...
            presenceData.details = document.title.replace('im Livestream anschauen | Joyn','');
            presenceData.state = 'Live-TV';
            presenceData.smallImageKey = "live";
            presenceData.smallImageText = 'Live';
        }
