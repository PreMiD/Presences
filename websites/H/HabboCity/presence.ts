...
presence.on("UpdateData", () => {
	...
	if (window.location.pathname.toLowerCase().startsWith("/profil/")) {
		...
		if (
			...
			window.document.querySelector("#profil87").style.display === "block" &&
	...
	if (window.location.pathname.toLowerCase() === "/news") {
		...
		if (
			...
			window.document.querySelector("#search1").style.display === "block"
		) {
			const search = (
	...
	if (window.location.pathname.toLowerCase() === "/community/fansites") {
		...
		if (
			...
			window.document.querySelector("#f37").style.display === "block"
		) {
	...
	if (window.location.pathname.toLowerCase() === "/boutique/coffres") {
		...
		if (
			window.document.querySelector("#boutiqueload").style.display ===
				"block" &&
	...
	if (window.location.pathname.toLowerCase() === "/settings") {
		...
		if (
			window.document.querySelector("#settings16").style.display === "block" &&
	...
	if (
		...
		window.document.querySelector("#cityclub").style.display === "block"
	) {
	...
	if (window.location.pathname.toLowerCase().startsWith("/boutique")) {
		...
		if (
			...
			window.document.querySelector("#b106").style.display === "block"
		) {
			presenceData.details = "Boutique - Mon inventaire";
		...
		if (
			...
			window.document.querySelector("#b210").style.display === "block"
		) {
			presenceData.details = "Boutique - Mon inventaire";
	...
	if (
		...
		window.document.querySelector("#fil1").style.right === "0px"
	) {
	...
	if (
		...
		window.document.querySelector("#rydHSG45s").style.display === "block"
	) {
	...
	if (
		...
		window.document.querySelector("#rydHSG45si").style.display === "block"
	) {
	...
	if (
		...
		window.document.querySelector("#Parrainage").style.display === "block"
	) {
	...
	if (
		...
		window.document.querySelector("#ai1").style.display === "block"
	) {
