const presence = new Presence({
  ...
  presence.on("UpdateData", async () => {
	...
	if (document.location.pathname === "/" || document.location.pathname === "/login") 
	  ...
	  presenceData.state = `Off: ${persred.textContent}% ` + `Def: ${persblue.textContent}% ` + `Gen: ${persgrn.textContent}%`;
	  ...
	  if (iterminal) 
		module = document.querySelector("#layout-wrapper > div.main-content > div > div:nth-child(2) > div > div > h4");
	   else 
		module = document.querySelector("#layout-wrapper > div.main-content > div > div:nth-child(1) > div > div > h4");
	  ...
	  module2 = document.querySelector("#app > div:nth-child(1) > div > div > h4");
