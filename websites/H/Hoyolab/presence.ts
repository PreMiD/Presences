...
presence.on('UpdateData', async () => {
  ...
  const circleName: Record<number, string> = {
    1: 'Honkai Impact 3rd',
    2: 'Genshin Impact',
    4: 'Tears of Themis',
    5: 'HoYoLAB',
  ...
  const circleTabName: Record<number, string> = {
    // Genshin Impact
    27: 'Official posts',
    28: 'Player guides',
    29: 'Fan arts',
  ...
  const accountCenterState: Record<string, string> = {
    postList: 'Posts',
    replyList: 'Comments',
    favList: 'Favorites',
    topicList: 'Topics',
  ...
  const homepageName: Record<string, string> = {
    timeline: 'Timeline',
    events: 'Events',
  }
