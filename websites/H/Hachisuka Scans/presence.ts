...
presence.on("UpdateData", async () => {
  ...
  if (document.location.pathname.includes("/")) {
    if ((document.title.includes("Você pesquisou por"))) {
      ...
      presenceData.buttons = [{label: "Hachisuka Scans",url: document.URL}];
    }
   ...
   const userPageSelect = document.querySelector("#post-5 > div.entry-content > div > div > div.col-md-3.col-sm-3 > div > ul > li.active"),
    ...
    obraNum = document.querySelector("body > div.wrap > div > div > div.c-page-content.style-1 > div > div > div > div > div > div > div.c-page__content > div.tab-wrap > div > div.h4");
    ...
    genrTexto = document.querySelector("body > div.wrap > div > div > div.c-page-content.style-1 > div > div > div > div > div.main-col-inner > div > div.entry-header > div > div > h1");
    ...
    mangaNome = document.querySelector("body > div.wrap > div > div > div > div.profile-manga.summary-layout-2 > div > div > div > div.post-title > h1");
    ...
    readerMangaNome = document.querySelector("#manga-reading-nav-head > div > div.entry-header_wrap > div > div.c-breadcrumb > ol > li:nth-child(2) > a");
