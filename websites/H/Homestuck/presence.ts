...
presence.on("UpdateData", async () => {
  ...
  switch (pathArr[1]) {
    ...
    case "jailbreak":
      ...
      presenceData.smallImageText = document.getElementsByTagName('h2')[0].textContent;
    ...
    case "story":
      ...
      if(document.getElementsByTagName('h2')[0]){
        ...
        presenceData.smallImageText = document.getElementsByTagName('title')[0].textContent;
      }
      presenceData.buttons = [{
        label: "Read Along",
        url: `https://www.homestuck.com` + pathStr
    ...
    case "epilogues":
      ...
      presenceData.smallImageKey = "prologue";
    ...
    case "extras":
      if (!pathArr[2]) {
        ...
        if (document.getElementsByTagName('h2')[0].textContent.length <= 128) {
          ...
          presenceData.smallImageText = document.getElementsByTagName('h2')[0].textContent.substring(0, 124) + "...";
        }
      }
      break;
    ...
    case "log":
      switch (pathArr[2]) {
        ...
        case "story":
          ...
          break;
        case "epilogues":
          presenceData.details = "Viewing The Homestuck Epilogues adventure log";
          break;
      }
      break;
