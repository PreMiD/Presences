...
let details: string, state: string, numbers: string, strikes: string, lives: string, level: string, strikes: string = "0 of 3", numbers: string = "4";
...
presence.on("UpdateData", async () => {
    ...
    const presenceData: PresenceData = {
      ...
      if (document.location.pathname == "/") {
        ...
        if (document.querySelector(".css-0") == null && document.querySelector(".css-1tl77r2") == null) {
          details = "Testing...";
          ...
          details = "Testing...";
          state = `Chimp Test (${numbers} numbers, ${strikes} strikes)`;
        }  else if (document.querySelector(".css-1tl77r2") == null && document.querySelector(".css-0") != null) {
        ...
        if (document.querySelector(".css-0") == null && document.querySelector(".big-score") == null) {
          details = "Testing...";
          state = `Visual Memory`;
        } else if (document.querySelector(".big-score") != null) {
          lives = document.querySelector(".big-score").getElementsByClassName("score").item(1).textContent.split("  ").join(" ");
          level = document.querySelector(".big-score").getElementsByClassName("score").item(0).textContent.split("  ").join(" ");
          details = "Testing...";
