...
presence.on("UpdateData", async () => {
    ...
    if (page.startsWith("/anime/")) {
        ...
        presenceData.state = document.querySelector("#root > div.anime-body > div.anime-white-informations > div.anime-white-infos > div:nth-child(2) > h1").textContent;
        ...
        presenceData.state = document.querySelector("#root > div:nth-child(3) > div.profil-banner-top > div > div.bloc-name-banner > h1").textContent;
        presenceData.buttons = [
            {
                label: "Profil",
                url: document.location.href
