	...
	switch (key) {
		...
		case "pause":
			if (
				...
				if (
					!document.getElementsByClassName(
						"player__button player__button--stopped"
					)[0].style.display
				)
					document
						.getElementsByClassName("player__button player__button--playing")[0]
						.click();
			} else {
				if (
					!document.getElementsByClassName(
						"player__button player__button--playing"
					)[0].style.display
				)
					document
						.getElementsByClassName("player__button player__button--stopped")[0]
						.click();
			}
		//Skip
		//------------------------------------------------------------------------------
		case "nextTrack":
			if (
				!document.getElementsByClassName(
					"player__button player__button--next"
				)[0].style.display
			)
				document
					.getElementsByClassName("player__button player__button--next")[0]
					.click();
			break;
		//Rewind
		//------------------------------------------------------------------------------
		case "previousTrack":
			if (
				!document.getElementsByClassName(
					"player__button player__button--prev"
				)[0].style.display
			)
				document
					.getElementsByClassName("player__button player__button--prev")[0]
					.click();
			break;
		//------------------------------------------------------------------------------
	}
