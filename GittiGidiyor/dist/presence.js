...
presence.on("UpdateData", () => __awaiter(this, void 0, void 0, function* () {
    const page = document.location.pathname,
        productName = document.querySelector("#sp-title") || document.querySelector("#ProductTitle > div.h1-container > h1 > span.title"),
        price = document.querySelector(".lastPrice") || document.querySelector("#col-center > div > div.border-e3e3e3 > ul.table-ul.gray-content.border-top-e3e3e3 > li.row-li.product-detail-product-price-info-ab-variant > ul > li.col-li.gg-w-17.gg-d-17.gg-t-16.gg-m-16.posr > div:nth-child(2) > div > div.low-price.extra-price.all-price.robotobold.clear.pl8.pt5"),
        seller = document.querySelector("#store-page-title > div.store-name > h1");
