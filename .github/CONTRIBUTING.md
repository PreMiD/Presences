...
- The name of settings must be in title case. This means that all words must be capitalized except for short prepositions. (for e.g.`Show Browsing Status` or `Show Videos and Clips`)
