...
- The ``buttons`` field is intended to show buttons on your presence. They have their own rules too. Your presence must follow them or your presence can be denied.
...
`Revision 3` of the guidelines was written and was contributed to by the following inviduals:
