...
presence.on("UpdateData", () =>
	__awaiter(this, void 0, void 0, function* () {
		...
		if (document.location.pathname == "/") {
			...
			document.location.pathname.includes("/forums/etcetera-forum.9/")
		) {
			presenceData.startTimestamp = browsingStamp;
			...
			document.location.pathname.includes("/forums/-/latest-threads/")
		) {
			presenceData.startTimestamp = browsingStamp;
			...
			document.location.pathname.includes("/account/account-details")
		) {
			presenceData.startTimestamp = browsingStamp;
