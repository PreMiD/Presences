...
presence.on("UpdateData", async () => {
	const page = document.location.pathname,
		searchingFor = document.querySelector("#app > main > div.sc-fzqARJ.ezHzMZ > div > div.sc-fzqARJ.eYJPYt > div.sc-fzqARJ.jzDIJt > h1") ||
	...
	if (page.includes("/c/") && (category && category.textContent != "")) {
		...
		page.includes("?searchTerm") || (searchingFor && searchingFor.textContent != "")) {
		presence.setActivity({
			largeImageKey: "letgo-logob",
