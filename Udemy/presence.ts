...
presence.on("UpdateData", async () => {
    ...
    if (page.includes("/courses/search")) {
        ...
        const title = document.querySelector("#udemy > div.main-content-wrapper > div.main-content > div > div > div.app--row--1ydzX.app--header--3crNp > div > div > div.header--course-details--3Swxk > a > span > span:nth-child(1) > span") || document.querySelector("#udemy > div:nth-child(26) > div.generic-modal.fade.in.modal > div > div > div > div > div > div > div.course-preview__title > span.course-preview__text"),
            episode = document.querySelector("#udemy > div.main-content-wrapper > div.main-content > div > div > div.app--column-container--3AItG > div > div.app--row--1ydzX.app--body-container--10gJo > div > div > div > div > div > div > div > div > div > div.lecture-view--container--pL22J > div > div.user-activity--hide-when-user-inactive--pDPGx > div.video-viewer--title-overlay--OoQ6e.video-viewer--title-overlay-no-sidebar--1BzL_") || document.querySelector("#udemy > div.main-content-wrapper > div.main-content > div > div > div.app--column-container--3AItG > div.app--sidebar-column--2t0E8 > div > div.sidebar--content---4z0- > div > div:nth-child(1) > div > div.section--title--eCwjX > span > span:nth-child(1)"),
