...
var title : any, pageNumber : any, jobPageNumber : any, usersortagsPageNumber : any, allPages : any, lastPage : any, jobLastPage : any, questionsLastPage : any;
...
presence.on("UpdateData", async () => {
  ...
  } else if(document.location.pathname == "/questions" && pageNumber.innerText.length > 0) {
