...
presence.on("UpdateData", async () => {
  var title = (document.querySelector(
    ...
    current = (document.querySelector("#wimp > div > div > div > div.footerPlayer--2d1-L > div.bottomRow--25xS1 > div.rightColumn--ZsskN > div:nth-child(2) > time.currentTime--2fCqA") as HTMLElement).innerText,
	fulltime = (document.querySelector("#wimp > div > div > div > div.footerPlayer--2d1-L > div.bottomRow--25xS1 > div.rightColumn--ZsskN > div:nth-child(2) > time.duration--3f3-B") as HTMLElement).innerText,
	playingfrom = (document.querySelector("#wimp > div > div > div > div.footerPlayer--2d1-L > div.bottomRow--25xS1 > div.leftColumn--5B2JF > div.dragItem--3WWiC > div.mediaInformation--1dAUh > div.container--UiaTi.playingFrom--3x_p7 > a > h4") as HTMLElement).innerText,
