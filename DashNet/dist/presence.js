...
presence.on("UpdateData", () => {
    ...
    if (document.location.pathname.includes("/cookieclicker/")) {
        var cookies = document.querySelector("#cookies").textContent.replace(document.querySelector("#cookies div").textContent, "");
        if (cookies.includes(" cookies")) {
            presenceData.details = cookies;
        } else {
            presenceData.details = cookies.replace("cookies", " cookies");
        }
        presenceData.state = document.querySelector("#cookies div").textContent.replace("per second :", "Per second:");
        presenceData.smallImageKey = "legacyy";
        presenceData.smallImageText = "Legacy level: " + document.querySelector("#ascendNumber").textContent;
