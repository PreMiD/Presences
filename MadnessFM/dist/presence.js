...
presence.on("UpdateData", async() => {
  ...
  if(document.location.pathname == "/"){
  ...
  else if((document.location.pathname == "/home.php"  || document.location.pathname == "/home")){
    ...
    presenceData.smallImageKey = "search";
    presenceData.smallImageText = "Please keep us on air! Our DJs need this station!"
  }
  else{
    presenceData.startTimestamp = browsingStamp;
