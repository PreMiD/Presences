...
var AppName : any, topicTitle : any, topicAuthor : any, broadcastTitle : any, broadcaster : any, itemName : any, itemPrice : any, workshop : any;
...
if(document.location.hostname == "steamcommunity.com") {
  ...
  if(document.location.pathname == "/" || !document.location.pathname) {
    ...
    var parts = document.location.href.split("/");
    var result = parts[parts.length - 2].replace(/%20/g,' ').replace(/%26/g,'&');
