...
presence.on("UpdateData", async () => {
	...
	if (document.location.pathname == ("/")) {
		...
		if (document.location.href.endsWith("=alt")) { // Alternative
			if (fullName.includes(" Special")) {

				if (fullName.includes(" Specials Episodio ")) { // Specials OLD
			...
			} else if (fullName.includes(" Movie ")) { // Movies
			...
			} else if (fullName.includes(" OVA ")) { //OVA
