...
const presence = new Presence({
  ...
  var profile: any, title: any, message: any;
  var browsingStamp = Math.floor(Date.now() / 1000);
  
function getUserName(): void { // Get your own username
...
async function getProfileDetails() { // Gets profile from the user you're viewing.
      ...
      if (
        ...
        if(document.location.pathname.includes("/home")) {
            if(document.location.pathname.includes("/worlds")) {
                ...
                presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/world")) { /* Viewing a specific world*/
            ...
            else if(document.location.pathname.includes("/avatars")) { /* Viewing Avatars*/
              presenceData.details = "Browsing Avatars";
              presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/messages")) { /* Viewing Messages*/
              presenceData.details = "Viewing Messages";
              presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/user")) { /* Viewing a specific user*/
              getProfileDetails();
            }
            else if(document.location.pathname.includes("/profile")) { /* Viewing Profile*/
              presenceData.details = "Viewing Profile";
              presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/search")) { /* Searching */
              ...
              presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/avatar")) { /* Viewing a specific avatar*/
            ...
            else if(document.location.pathname.includes("/playermoderations")) { /* Viewing blocks & mutes*/
              presenceData.details = "Viewing Blocks & Mutes";
              presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/accountlink")) { /* Viewing the account link page*/
              presenceData.details = "Merging Account";
              presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/download")) { /* Viewing Download Page*/
              ...
              presence.setActivity(presenceData);
                ...
                presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/register")) {  /* Register Page*/
                presenceData.state = "Creating an account";
                presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/password")) { /* Password Page*/
                presenceData.state = "Resetting Password";
                presence.setActivity(presenceData);
            } else if(document.location.pathname.includes("/twofactorauth")) { /* 2FA Page*/
