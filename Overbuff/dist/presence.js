...
presence.on("UpdateData", () => {
  ...
  if (window.location.pathname.includes("/players/")) {
    var nickname = document.querySelector("div.layout-header-primary-bio > h1")
    ...
    try {
      var hero_name = document.querySelector(
        "div.layout-header-primary-bio > div > h1"
      ).firstChild.textContent;
      var hero_role = document.querySelector(
    ...
    try {
      var role_name = document.querySelector(
        "div.layout-header-primary-bio > div > h1"
      ).firstChild.textContent;
    ...
    try {
      var blog_title = document.querySelector("div.post-title > h1.title")
        .textContent;
