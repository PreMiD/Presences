...
presence.on("UpdateData", async () => {
    ...
    if (path[0] === "h") {
        ...
        const classroom: string = document.querySelector("span[class=\"YVvGBb dDKhVc\"]") ? `${document.querySelector("span[id=\"UGb2Qe\"]").textContent} - ${document.querySelector("span[class=\"YVvGBb dDKhVc\"]").textContent}` : document.querySelector("span[id=\"UGb2Qe\"]").textContent;
