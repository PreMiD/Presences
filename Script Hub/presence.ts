    ...
    if (path === "/") {
        ...
        if (path === "/docs/") {
            ...
            if (route[1] === "home") {
                ...
                if (route[1] === "home?id=sobre-nosotros") {
                    presenceData.details = "Documentación - Inicio"
                    ...
                    if (route[1] === "general") {
                        ...
                        if (route[2] === "indice") {
                            ...
                            if (route[2] === "indice?id=listado-y-estatus-de-las-gu%c3%adas") {
                        ...
                        if (route[1] === "guias") {
                            ...
                            if (route[2] === "creando-aplicaci%C3%B3n-de-discord") {
                                let a = route[2],
                                    b = `${a[0].toUpperCase()}${a.slice(1).toLocaleLowerCase()}`,
                                    c = `${b.includes("-") ? b.replace(/-/g, " ") : b}`,
                                    d = c.split("?")
                                presenceData.state = `${c.includes("?") ? d[0] : c}`
                            } else
                                if (route[2] === "utilizando-git") {
                                    let a = route[2],
                                        b = `${a[0].toUpperCase()}${a.slice(1).toLocaleLowerCase()}`,
                                        c = `${b.includes("-") ? b.replace(/-/g, " ") : b}`,
                                        d = c.split("?")
                                    ...
                                    if (route[2] === "alojando-bot-en-heroku") {
                                        let a = route[2],
                                            b = `${a[0].toUpperCase()}${a.slice(1).toLocaleLowerCase()}`,
                                            c = `${b.includes("-") ? b.replace(/-/g, " ") : b}`,
                                            d = c.split("?")
                                        ...
                                        if (route[2] === "asignar-base-de-datos-en-heroku") {
                                            let a = route[2],
                                                b = `${a[0].toUpperCase()}${a.slice(1).toLocaleLowerCase()}`,
                                                c = `${b.includes("-") ? b.replace(/-/g, " ") : b}`,
                                                d = c.split("?")
