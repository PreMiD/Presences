...
presence.on("UpdateData", () => {
    ...
    if (document.URL === "https://www.threenow.co.nz/") {
        ...
        if (document.getElementsByClassName("EpisodeSynopsis-subtitle").length >= 1) {
            ...
            presenceData.state = document.getElementsByClassName("EpisodeSynopsis-title")[0].innerText
            ...
            presenceData.state = document.getElementsByClassName("HeroSynopsis-title")[0].innerText
        }
        ...
        presenceData.startTimestamp = Math.floor(Date.now() / 1000);
    } else if (document.location.pathname.includes("/tv") && document.location.pathname.includes(".html")) {
