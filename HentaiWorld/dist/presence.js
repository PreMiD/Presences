        ...
        (data.smallImageKey = "new"),
          ...
          (data.state =
            ...
            document.location.href
              .startsWith("https://www.hentaiworld.eu/newest?page=")
              .replace("https://www.hentaiworld.eu/newest?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "new"),
      ...
      if (
        ...
        (data.smallImageKey = "new"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/updated?page=")
              .replace("https://www.hentaiworld.eu/newest?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
      ...
      if (
        ...
        (data.smallImageKey = "schedule"),
          ...
          (data.state =
            "Hentai. Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/ongoing?page=")
              .replace("https://www.hentaiworld.eu/ongoing?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "schedule"),
      ...
      if (
        ...
        (data.smallImageKey = "search"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/tv-series?page=")
              .replace("https://www.hentaiworld.eu/tv-series?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "search"),
      ...
      if (
        ...
        (data.smallImageKey = "search"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/movies?page=")
              .replace("https://www.hentaiworld.eu/movies?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "search"),
      ...
      if (
        ...
        (data.smallImageKey = "search"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/ova?page=")
              .replace("https://www.hentaiworld.eu/ova?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "search"),
      ...
      if (
        ...
        (data.smallImageKey = "search"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/ona?page=")
              .replace("https://www.hentaiworld.eu/ona?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "search"),
      ...
      if (
        ...
        (data.smallImageKey = "search"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/specials?page=")
              .replace("https://www.hentaiworld.eu/specials?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "search"),
      ...
      if (
        ...
        (data.smallImageKey = "search"),
          ...
          (data.state =
            "Page: " +
            document.location.href
              .startsWith("https://www.hentaiworld.eu/preview?page=")
              .replace("https://www.hentaiworld.eu/preview?page=", "")),
          (data.startTimestamp = browsingStamp);
        presence.setActivity(data);
      } else {
        (data.smallImageKey = "search"),
