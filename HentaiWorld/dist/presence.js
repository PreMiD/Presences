...
if (document.location.pathname == ("/")) {
    ...
    presence.setActivity(data);}
        ...
        data.state = document.title.split('"')[1] + "Page: " + document.location.href.split("=")[0],
        data.startTimestamp = browsingStamp;
        presence.setActivity(data);
        } else {
    data.smallImageKey = "search",
    ...
    presence.setActivity(data);
        ...
        data.state = "Page" + document.location.href.split("=")[0],
        data.startTimestamp = browsingStamp;
        presence.setActivity(data);
        } else
    data.smallImageKey = "archive",
...
if (document.location.pathname == ("/")) {
    ...
    presence.setActivity(data);}
        ...
        data.state = "Pagina: " + document.location.href.split("=")[0],
        data.startTimestamp = browsingStamp;
        presence.setActivity(data);
        } else {
    data.smallImageKey = "search",
    ...
    presence.setActivity(data);}
        ...
        if (document.location.href.startsWith("https://www.hentaiworld.eu/ongoing?page=")) {
        data.smallImageKey = "schedule",
        data.details = "Sfoglia gli anime in",
        data.state = "corso. Pagina: " + document.location.href.startsWith("https://www.hentaiworld.eu/ongoing?page=").replace("https://www.hentaiworld.eu/ongoing?page=", ""),
        data.startTimestamp = browsingStamp;
        presence.setActivity(data);
        } else {
    data.smallImageKey = "schedule",
    data.details = "Sfoglia gli anime in",
    data.state = "corso. Pagina: 1",
    data.startTimestamp = browsingStamp;
    presence.setActivity(data);}
	}
    else if (document.location.pathname.startsWith("/upcoming")) { // Upcoming
    ...
    presence.setActivity(data);
        ...
        if (document.location.href.includes("?page=")) {
        data.smallImageKey = "archive",
        data.details = "Sfoglia tutti gli anime",
        data.state = "Pagina" + document.location.href.split("=")[0],
        data.startTimestamp = browsingStamp;
        presence.setActivity(data);
        } else
